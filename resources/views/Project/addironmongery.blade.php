                            ...
                            <div class="">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-icons">
                                            <input type="text" min="0" name="discountprice" value="@if(session()->has('item')){{session()->get('item')->discountprice}}@endif" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1'); if(!/^\d*\.?\d{0,2}$/.test(this.value)) { this.value = this.value.slice(0, -1); }">
