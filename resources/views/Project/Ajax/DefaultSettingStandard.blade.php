<div class="form-row">
    ...
    <div class="col-md-6 framehideshow">
        <div class="position-relative form-group">
            ...
            <input type="number" id="frameThickness" name="frameThickness" value="@if(isset($defaultItemsStandard->FrameThickness)){{$defaultItemsStandard->FrameThickness}}@else{{'32'}}@endif" class="form-control change-event-calulation door-configuration" required min="28">
        </div>
    </div>
    <div class="col-md-6">
        <div class="position-relative form-group">
