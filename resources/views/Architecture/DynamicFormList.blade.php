                                    ...
                                    <div class="dropdown-menu-header-inner bg-primary">
                                        <div class="menu-header-content">
                                            <div class="avatar-icon-wrapper mb-3 avatar-icon-xl">
                                                ...
                                                @if(!empty($form->CompanyPhoto))
                                                    <img
                                                        src="{{url('/public/CompanyLogo/'.$form->CompanyPhoto)}}"
                                                        alt="Avatar 5">
                                                @else
                                                <img
                                            ...
                                            <div><h5 class="menu-header-title">{{$form->CompanyName}}</h5><h6 class="menu-header-subtitle">on configuration</h6></div>
