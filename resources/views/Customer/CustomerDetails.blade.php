                ...
                <div class="container company-background pt-5">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            @else
                            <img class="company-logo" src="{{url('CompanyLogo/default-image.jpg')}}" alt="Customer logo">
                            @endif
                        </div>
                        <div class="col-sm-8 company-details">
                            <a href="{{url('customer/edit/'.$data->id)}}" class="btn-shadow btn btn-info float-right">
