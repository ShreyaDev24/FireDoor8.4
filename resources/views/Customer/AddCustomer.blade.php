                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade active show" id="tab1" role="tabpanel" aria-labelledby="tab1">
                            <div class="main-card mb-3 card">
                                ...
                                <div class="card-body">
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="position-relative form-group"><label for="CompanyName"
                                                    class="">Company Name<span class="text-danger">*</span></label>
                                                <input id="CompanyName" name="CstCompanyName" required placeholder="Enter Company Name"
                                                value="@if(isset($editdata->id)){{$editdata->CstCompanyName}}@else{{(old('CstCompanyName'))}}@endif"
                                                    type="text" class="form-control" onkeypress="keyprs(this.value)" pattern="[A-Za-z].{3,}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="Website url" class="">Website</label>
                                                <input name="CstCompanyWebsite"
                                                    value="@if(isset($editdata->id)){{$editdata->CstCompanyWebsite}}@else{{(old('CstCompanyWebsite'))}}@endif"
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                ...
                                                <input name="CstCompanyEmail"
                                                    ...
                                                    class="form-control" onkeypress="keyprs(this.value)" id="useremail">
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative form-group"><label for="Company Phone"
                                                ...
                                                <input name="CstCompanyPhone" type="number"
                                        ...
                                        <div class="col-md-12">
                                            <div class="position-relative form-group">
                                                ...
                                                <textarea name="CstMoreInfo" id="CstMoreInfo"
                                                    ...
                                                    class="form-control" rows="4" onkeypress="keyprs(this.value)">@if(isset($editdata->id)){{$editdata->CstMoreInfo}}@else{{(old('CstMoreInfo'))}}@endif </textarea>
                                            </div>
                                        </div>
                                    ...
                                    <button name="company" type="button" class="btn btn-primary pull-right"
                                        id="companyDetails" onclick="velidateFunctions()">Save & Next </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="tab5" role="tabpanel" aria-labelledby="tab5">
                            <div class="main-card mb-3 card">
                                ...
                                @if(isset($CustomerContactDetails) && (!empty($CustomerContactDetails)))
                                    @php
                                        $Count = 1;
                                    @endphp
                                    @foreach($CustomerContactDetails as $ContactKey => $ContactVal)
                                    <div class="form-row" id="customer-details-{{$Count}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                ...
                                                <input type="text" required name="ContactJobTitle[]" id="ContactJobTitle-{{$Count}}"
                                                class="form-control" value="{{$ContactVal->ContactJobtitle}}" placeholder="Enter Job Title" onkeypress="keyprs(this.value)">
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                ...
                                                <input name="ContactPhone[]" type="number"
                                    ...
                                    <div class="form-row" id="customer-details-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                ...
                                                class="form-control" placeholder="Enter Job Title" onkeypress="keyprs(this.value)">
                                ...
                                <div class="d-block text-right card-footer">
                                    <button type="submit" id="click_btn" onclick="submit_form()" class="btn-wide btn btn-success"
...
<script type="text/javascript">
    ...
    $("#OfficeAddressSubmit").click(function() {
        // if(CstCompanyAddressLine1.trim() == '' || CstCompanyCountry.trim() == '' || CstCompanyState.trim() == '' || CstCompanyCity.trim() == '' || CstCompanyPostalCode.trim() == '' ){
        ...
        var CustomerDetails = `<div class="form-row" id="customer-details-`+ CustomerCounter +`">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="ContactJobTitle" class="">Job Title<span class="text-danger">*</span></label>
                                                <input type="text" required name="ContactJobTitle[]" id="ContactJobTitle-` + CustomerCounter + `"
