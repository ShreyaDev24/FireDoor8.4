<div class="card mb-3">
    <div class="card-body">
        ...
        {{-- IntumescentSealColor Name --}}
        <div class="row">
            <div class="col-md-12 mb-3">
                <label>IntumescentSealColor <span class="text-danger">*</span></label>
                <input type="text"
                    name="IntumescentSealColor"
                    class="form-control @error('IntumescentSealColor') is-invalid @enderror"
                    value="{{ old('IntumescentSealColor', $item->IntumescentSealColor ?? '') }}"
                    required>

                @error('IntumescentSealColor')
