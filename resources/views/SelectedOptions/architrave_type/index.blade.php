...
<div class="app-main__outer">
    ...
    <div class="app-main__inner">
        ...
        <div class="d-flex justify-content-between mb-3">
            <h4>Architrave Type</h4>
            <a href="{{ route('Architrave-Type.create') }}" class="btn btn-primary">
                + Add New
            </a>
        </div>
        @if($auth->id != 1)
        ...
        <table class="table table-bordered table-hover" style="table-layout:auto;" id="Architrave_TypeTable">
            <thead>
                <tr>
                    @if($auth->id != 1)
                    <th>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="d-flex justify-content-center align-items-center gap-2">
                            ...
                            {{-- Edit --}}
                            <a href="{{ route('Architrave-Type.edit', $item->id) }}"
                            ...
                            {{-- Delete --}}
                            <form action="{{ route('Architrave-Type.destroy', $item->id) }}"
                                method="POST"
                    ...
                    <td style="min-width: 80px;">
                        <input type="number"
                            ...
                            data-option-type="Architrave_Type"
...
$(document).ready(function () {
    ...
    let table = $('#Architrave_TypeTable').DataTable({
        pageLength: 10,
    ...
    $('#updateSelected').on('click', function () {
        ...
        fetch("{{ route('Architrave-Type.updateSelected') }}", {
            method: "POST",
            headers: {
...
$('#exportSelected').on('click', function () {
    ...
    form.method = 'POST';
    form.action = "{{ route('Architrave-Type.exportSelected') }}";
