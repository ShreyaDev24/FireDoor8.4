...
<div class="app-main__outer">
    ...
    <div class="app-main__inner">
        ...
        <form action="{{ route('Door-Dimension-Custom.update',$item->id) }}" method="POST"  enctype="multipart/form-data">
            @csrf
            @method('PUT')

            @include('SelectedOptions.door_dimension_custom._form', ['item' => $item])
