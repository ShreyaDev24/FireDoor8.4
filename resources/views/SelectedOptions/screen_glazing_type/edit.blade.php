...
<div class="app-main__outer">
    ...
    <div class="app-main__inner">
        ...
        <form action="{{ route('Screen-Glazing-Type.update',$item->id) }}" method="POST"  enctype="multipart/form-data">
            @csrf
            @method('PUT')

            @include('SelectedOptions.screen_glazing_type._form', ['item' => $item])
