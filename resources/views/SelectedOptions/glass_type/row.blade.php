...
<div class="app-main__outer">
    ...
    <div class="app-main__inner">
        ...
        <div class="d-flex justify-content-between mb-3">
            <h4>Glass Type</h4>
            <a href="{{ route('Glass-type.create') }}" class="btn btn-primary">
                + Add New
            </a>
        </div>
        @if($auth->id != 1)
        ...
        <table class="table table-bordered table-hover" style="table-layout:auto;" id="glass_typeTable">
            <thead>
                <tr>
                    @if($auth->id != 1)
                    <th>
                ...
                <tr>
                    ...
                    <td style="min-width: 8 0px;">
                        <input type="number" step="0.01" class="form-control priceInput"
                            ...
                            data-option-type="glass_type" onkeyup="chooseOptionCost(this)">
                    </td>
                    @elseif($auth->id != 1)
                    <td></td>
                    @endif
...
<script>
    ...
    let table = $('#glass_typeTable').DataTable({
        pageLength: 10,
...
@endsection
need to add tab custom and standard
custom door include
stredoor
halspan
flamebreak
