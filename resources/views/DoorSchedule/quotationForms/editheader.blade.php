                ...
                <div class="row">
                    ...
                    <div class="col-md-6" data-select2-id="4">
                        <div class="position-relative form-group">
                            ...
                            <select name="projectId" class="form-control selectprojectId" >
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            <label for="ProductName">Sales Contact<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="SalesContact"
                    ...
                    <div class="col-md-12">
                        <div class="position-relative form-group">
                            ...
                            <textarea
                                ...
                                class="form-control"
                                rows="3"
                                placeholder="Describe the differences between this revision and the previous revision...">@if(!empty($quotation->RevisionDescription)){{$quotation->RevisionDescription}}@endif</textarea>
            ...
            <div class="col-sm-6">
                ...
                <div class="col-md-12 p-0">
                    <div class="position-relative form-group">
                        ...
                        <select name="Contact" id="CustomerContactIdSTC_Name" class="form-control CustomerId">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            <label for="Email">Email<span
                                    class="text-danger">*</span></label>
                            <input type="email" class="form-control" name="Email" id="CustomerContactIdSTC_Email"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="number" onkeydown="if(event.key==='.'){event.preventDefault();}" pattern="\d" class="form-control"
                                name="Phone" id="CustomerContactIdSTC_Phone"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="number" onkeydown="if(event.key==='.'){event.preventDefault();}" pattern="\d" class="form-control"
                                name="Mobile" id="CustomerContactIdSTC_Mobile"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="number" onkeydown="if(event.key==='.'){event.preventDefault();}" class="form-control" name="Fax" id="CustomerContactIdSTC_Fax"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            <label for="Address1">Address 1<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="Address1[]" id="searchTextField"
                                value="@if(!empty($QuotationShipToInformation->Address1)){{$QuotationShipToInformation->Address1}} @elseif(!empty($ProjectsAddress->AddressLine1)) {{ $ProjectsAddress->AddressLine1 }}@endif" required>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="text" class="form-control" name="Address2[]"
                                value="@if(!empty($QuotationShipToInformation->Address2)){{$QuotationShipToInformation->Address2}}@elseif(!empty($ProjectsAddress->AddressLine2)) {{ $ProjectsAddress->AddressLine2 }}@endif">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="position-relative form-group">
                            ...
                            <input type="text" id="Country" class="form-control" name="Country[]"
                                value="@if(!empty($QuotationShipToInformation->Country)){{$QuotationShipToInformation->Country}}@elseif(!empty($ProjectsAddress->Country)) {{ $ProjectsAddress->Country }}@endif">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="position-relative form-group">
                            ...
                            <input type="text" class="form-control" name="City[]"
                                value="@if(!empty($QuotationShipToInformation->City)){{$QuotationShipToInformation->City}}@elseif(!empty($ProjectsAddress->City)) {{ $ProjectsAddress->City }}@endif" id="City">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="position-relative form-group">
                            ...
                            <input type="text" class="form-control" name="PostalCode[]"
                                value="@if(!empty($QuotationShipToInformation->PostalCode)){{$QuotationShipToInformation->PostalCode}}@elseif(!empty($ProjectsAddress->PostalCode)) {{ $ProjectsAddress->PostalCode }}@endif" id="PinCode">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="text" name="DeliveryRestrictions" class="form-control"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <select name="WagonPreference" class="form-control">
                                @php
                    ...
                    <div class="col-md-12">
                        <div class="position-relative form-group">
                            ...
                            <textarea name="Booking" id="Booking" cols="30" rows="10" class="form-control">@if(!empty($QuotationShipToInformation->Booking)){{$QuotationShipToInformation->Booking}}@endif</textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="position-relative form-group">
                            <label for="Deliverypolicy">Delivery policy including route into site etc</label>
                            <textarea name="Deliverypolicy" id="Deliverypolicy" cols="30" rows="10" class="form-control">@if(!empty($QuotationShipToInformation->Deliverypolicy)){{$QuotationShipToInformation->Deliverypolicy}}@endif</textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="radio" id="silver1" name="silver" value="Yes"
                            ...
                            <input type="radio" id="silver2" name="silver" value="No"
                            @if(!empty($QuotationShipToInformation->silver))
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            <label>Gold</label><br>
                            <input type="radio" id="gold1" name="gold" value="Yes"
                            ...
                            <input type="radio" id="gold2" name="gold" value="No"
                            @if(!empty($QuotationShipToInformation->gold))
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="text" name="Offloading" class="form-control"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="number" name="NoOfDeliveries" class="form-control"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="number" name="ActualNoOfDeliveries" class="form-control"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="number" name="AverageNoDoorsetsperdrop" class="form-control"
