                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu drop_style">
                                                                     <li><a onclick="favoriteItem('{{ $row->id }}','{{ $row->screenMasterid }}','Screen','Screen Favourite Item','Screen Type Name')"
                                                        ...
                                                        <td class="text-center">
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu drop_style">
                                                                    ...
                                                                    <li><a onclick="favoriteItem('{{ $row->itemId }}','{{ $row->id }}','Door','Configurable Favourite Item','Configurable Type Name')"
                                                                            href="javascript:void(0);">Name
                                                                            Configuration</a></li>
                                    ...
                                    <form action="{{ route('QuoteSummary') }}" method="post">
                                        ...
                                        <div class="quote_pricing">
                                            ...
                                            <button type="button" class="btn btn-primary mt-3"
                                                    style="color:#fff; font-size:15px; margin-left:26px;margin-top:-5px;margin-top: -7px !important;"
