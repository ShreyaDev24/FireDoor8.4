...
<body>
    ...
    <tbody>
        ...
        @include('DoorSchedule.ScreenBOM.GlazingBeads')
        @include('DoorSchedule.ScreenBOM.Frame')
        @include('DoorSchedule.ScreenBOM.Glass')
        @include('DoorSchedule.ScreenBOM.GlazingSystem')
        @include('DoorSchedule.ScreenBOM.GeneralLabourCosts')

    </table>

    <br>
    @include('DoorSchedule.ScreenBOM.Footer')
</body>
</html>
