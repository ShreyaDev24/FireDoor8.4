@php $i = 0; $check = 0; $total=0; $GTSellPrice=0;@endphp
    @foreach($data as $value)
        ...
        <tr style="background:#00B0F0">
            <td colspan="16"><b>Screen Frame</b></td>
        </tr>
        <tr style="margin-top:10px">
            <th>Screen Type</th>
            <th>Frame Location</th>
            <th  colspan="2">Frame Material </th>
            <th  colspan="2">Frame Finish</th>
            <th>Screen Dimension</th>
            <th>Qty Per Screen Type</th>
    ...
    @php
    global $Framestotal;
    global $FramestotalGTSell;

    $Framestotal=round($total,2);
    $FramestotalGTSell=round($GTSellPrice,2);
    @endphp
