    ...
    <div class="app-main__inner">
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('core_certificates.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        ...
                        <select id="fire_rating" name="fire_rating" class="form-control" required>
                            ...
                            <option value="FD30">NFR / FD30 / FD30s</option>
                            <option value="FD60">FD60 / FD60s</option>
                        </select>
                    </div>
                    <div class="mb-2">
                        <label>Test Certificate Reference</label>
                        <input type="text" id="test_certificate_reference"
                            name="test_certificate_reference" class="form-control" required>
                    </div>
                    <div class="mb-2">
