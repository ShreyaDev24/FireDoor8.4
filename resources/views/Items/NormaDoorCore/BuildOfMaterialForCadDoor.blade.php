    ...
    <div class="door_option_list">
        ...
        <table class="table">
                                        ...
                                        <tr id="doorType-section" class="@if(isset($Item["DoorType"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                            <td>Door Type</td>
                                            <td id="doorType-selected">@if(isset($Item["DoorType"])){{$Item["DoorType"]}}@endif</td>
    ...
    <div class="door_option_list">
        ...
        <table class="table">
                                        <tr id="sOWidth-section" class="@if(isset($Item["SOWidth"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                            <td>S.O Width</td>
                                            <td id="sOWidth-selected">@if(isset($Item["SOWidth"])){{$Item["SOWidth"]}}@endif</td>
                                            @if(price_view_vlidator()==1)
                                        ...
                                        <tr id="doorLeafFacing-section" class="@if(isset($Item["DoorLeafFacing"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                            ...
                                            @if(price_view_vlidator()==1)
                                            <td id="doorLeafFacing-price">
                                                @if(isset($Item["DoorLeafFacing"]))
                                                    @foreach($option_data as $row)
                                                        @if($row->OptionSlug=='Door_Leaf_Facing' && $Item["DoorLeafFacing"] == $row->OptionKey)
                                                            £{{$row->OptionCost}}
                                                            @break
                                                        @endif
                                                    @endforeach
                                        ...
                                        <tr id="doorLeafFacingValue-section" class="@if(isset($Item["DoorLeafFacingValue"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                            <td>Brand </td>
                                            <td id="doorLeafFacingValue-selected">@if(isset($Item["DoorLeafFacingValue"])){{$Item["DoorLeafFacingValue"]}}@endif</td>
                                            @if(price_view_vlidator()==1)
                                            <td id="doorLeafFacingValue-price">
                                                @if(isset($Item["DoorLeafFacingValue"]))
                                                    @foreach($option_data as $row)
                                                        @if($row->OptionSlug=='door_leaf_facing_value' && $Item["DoorLeafFacingValue"] == $row->OptionKey)
                                                            £{{$row->OptionCost}}
                                                            @break
                                                        @endif
                                                    @endforeach
                                        ...
                                        <tr id="doorLeafFinish-section" class="@if(isset($Item["DoorLeafFinish"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                            <td>Door Leaf Finish</td>
                                            <td id="doorLeafFinish-selected">@if(isset($Item["DoorLeafFinish"])){{$Item["DoorLeafFinish"]}}@endif</td>
                                            @if(price_view_vlidator()==1)
                                            <td id="doorLeafFinish-price">
                                                @if(isset($Item["DoorLeafFinish"]))
                                                    @foreach($option_data as $row)
                                                        @if($row->OptionSlug=='door_leaf_finish' && $Item["DoorLeafFinish"] == $row->OptionKey)
                                                            £{{$row->OptionCost}}
                                                            @break
                                                        @endif
                                                    @endforeach
                                        ...
                                        <tr id="doorLeafFinishColor-section" class="@if(isset($Item["DoorLeafFinishColor"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                            <td>Door Leaf Finish Color</td>
                                            <td id="doorLeafFinishColor-selected">@if(isset($Item["DoorLeafFinishColor"])){{$Item["DoorLeafFinishColor"]}}@endif</td>
                                            @if(price_view_vlidator()==1)
                                            <td id="doorLeafFinishColor-price">£0.00</td>
                                            @endif
                                        </tr>
                                        <tr id="decorativeGroves-section" class="@if(isset($Item["DecorativeGroves"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                            ...
                                            <td id="decorativeGroves-price">
                                                @if(isset($Item["DecorativeGroves"]))
                                                    @foreach($option_data as $row)
                                                        @if($row->OptionSlug=='Decorative_Groves' && $Item["DecorativeGroves"] == $row->OptionKey)
                                                            £{{$row->OptionCost}}
                                                            @break
                                                        @endif
                                                    @endforeach
                                        ...
                                        <tr id="grooveLocation-section" class="@if(isset($Item["GrooveLocation"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                            <td>Groove Location</td>
                                            <td id="grooveLocation-selected">@if(isset($Item["GrooveLocation"])){{$Item["GrooveLocation"]}}@endif</td>
                                            @if(price_view_vlidator()==1)
                                            <td id="grooveLocation-price">
                                                @if(isset($Item["GrooveLocation"]))
                                                    @foreach($option_data as $row)
                                                        @if($row->OptionSlug=='Groove_Location' && $Item["GrooveLocation"] == $row->OptionKey)
                                                            £{{$row->OptionCost}}
                                                            @break
                                                        @endif
                                                    @endforeach
            ...
            <h6><b>Vision Panel</b></h6>
                    <table class="table">
                                        <tr id="leaf1VisionPanel-section" class="@if(isset($Item["Leaf1VisionPanel"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                            ...
                                            <td id="leaf1VisionPanel-selected">@if(isset($Item["Leaf1VisionPanel"])){{$Item["Leaf1VisionPanel"]}}@endif</td>
                                            @if(price_view_vlidator()==1)
    ...
    <div class="door_option_list">
        ...
        <table class="table">
                                        <tr id="frameMaterial-section" class="@if(isset($Item["FrameMaterial"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                            ...
                                            <td id="frameMaterial-selected">@if(isset($Item["FrameMaterial"])){{$Item["FrameMaterial"]}}@endif</td>
                                            @if(price_view_vlidator()==1)
                                        ...
                                        <tr id="intumescentSealColor-section" class="@if(isset($Item["IntumescentSealColor"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                            <td>Intumescent Seal Color </td>
                                            <td id="intumescentSealColor-selected">@if(isset($Item["IntumescentSealColor"])){{$Item["IntumescentSealColor"]}}@endif</td>
                                            @if(price_view_vlidator()==1)
                                            <td id="intumescentSealColor-price">£0.00</td>
                                            @endif
                                        </tr>
    ...
    <div class="door_option_list">
            ...
            <table class="table">
                                        <tr id="overpanel-section" class="@if(isset($Item["Overpanel"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                            <td>Overpanel</td>
                                            <td id="overpanel-selected">@if(isset($Item["Overpanel"])){{$Item["Overpanel"]}}@endif</td>
                                            @if(price_view_vlidator()==1)
            ...
            <h6><b>Side Light</b></h6>
                    <table class="table">
                                        <tr id="sideLight1-section" class="@if(isset($Item["SideLight1"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                            <td>Side Light 1</td>
                                            <td id="sideLight1-selected">@if(isset($Item["SideLight1"])){{$Item["SideLight1"]}}@endif</td>
                                            @if(price_view_vlidator()==1)
            ...
            <h6><b>Lipping And Intumescent</b></h6>
                    <table class="table">
                                        <tr id="lippingType-section" class="@if(isset($Item["LippingType"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                            <td>Lipping Type</td>
                                            <td id="lippingType-selected">@if(isset($Item["LippingType"])){{$Item["LippingType"]}}@endif</td>
                                            @if(price_view_vlidator()==1)
                                        ...
                                        <tr id="lippingSpecies-section" class="@if(isset($Item["LippingSpecies"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                            ...
                                            <td id="lippingSpecies-selected">@if(isset($Item["LippingSpecies"])){{$Item["LippingSpecies"]}}@endif</td>
                                            @if(price_view_vlidator()==1)
                                        ...
                                        <tr id="intumescentSealArrangement-section" class="@if(isset($Item["IntumescentLeapingSealArrangement"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                            ...
                                            <td id="intumescentSealArrangement-selected">@if(isset($Item["IntumescentLeapingSealArrangement"])){{$Item["IntumescentLeapingSealArrangement"]}}@endif</td>
                                            @if(price_view_vlidator()==1)
                                            <td id="intumescentSealArrangement-price">£0.00</td>
                                            @endif
                                        </tr>
    ...
    <div class="door_option_list">
        ...
        <table class="table">
                                            <tr id="accoustics-section" class="@if(isset($Item["Accoustics"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                                <td>Accoustics </td>
                                                <td id="accoustics-selected">@if(isset($Item["Accoustics"])){{$Item["Accoustics"]}}@endif</td>
                                                @if(price_view_vlidator()==1)
                                            ...
                                            <tr id="accousticsJambs-section" class="@if(isset($Item["AccousticsJambs"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                                <td>Accoustics Jambs</td>
                                                <td id="accousticsJambs-selected">@if(isset($Item["AccousticsJambs"])){{$Item["AccousticsJambs"]}}@endif</td>
                                                @if(price_view_vlidator()==1)
                                                <td id="accousticsJambs-price">£0.00</td>
                                                @endif
                                            </tr>
                                            <tr id="accousticsHead-section" class="@if(isset($Item["AccousticsHead"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                                <td>Accoustics Head</td>
                                                <td id="accousticsHead-selected">@if(isset($Item["AccousticsHead"])){{$Item["AccousticsHead"]}}@endif</td>
                                                @if(price_view_vlidator()==1)
                                                <td id="accousticsHead-price">£0.00</td>
                                                @endif
                                            </tr>
                                            <tr id="thresholdSeal-section" class="@if(isset($Item["AccousticsThresholdSeal"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                                <td>Threshold Seal</td>
                                                <td id="thresholdSeal-selected">@if(isset($Item["AccousticsThresholdSeal"])){{$Item["AccousticsThresholdSeal"]}}@endif</td>
                                                @if(price_view_vlidator()==1)
                                                <td id="thresholdSeal-price">£0.00</td>
                                                @endif
                                            </tr>
                                            <tr id="accousticsSeal-section" class="@if(isset($Item["AccousticsSeal"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                                <td>Accoustics Seal</td>
                                                <td id="accousticsSeal-selected">@if(isset($Item["AccousticsSeal"])){{$Item["AccousticsSeal"]}}@endif</td>
                                                @if(price_view_vlidator()==1)
                                                <td id="accousticsSeal-price">£0.00</td>
                                                @endif
                                            </tr>
                                            <tr id="accousticsmeetingStiles-section" class="@if(isset($Item["AccousticsMeetingStiles"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                                ...
                                                @if(price_view_vlidator()==1)
                                                <td id="accousticsmeetingStiles-price">£0.00</td>
                                                @endif
                                            </tr>
    ...
    <div class="door_option_list">
        ...
        <table class="table">
                                            <tr id="Architrave-section" class="@if(isset($Item["Architrave"])){{'table_row_show'}}@else{{'table_row_hide'}}@endif">
                                                <td>Architrave  </td>
                                                <td id="Architrave-selected">@if(isset($Item["Architrave"])){{$Item["Architrave"]}}@endif</td>
                                                @if(price_view_vlidator()==1)
