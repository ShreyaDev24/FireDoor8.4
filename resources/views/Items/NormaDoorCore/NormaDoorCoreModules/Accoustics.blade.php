                                    ...
                                    <div>
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <input name="rWdBRating" id="rWdBRating" class="form-control"
                                                    @if(isset($Item['Accoustics']))
                                                        @if($Item['Accoustics'] != "Yes")
                                                            {{'readonly'}}
                                                        @else
                                                    ...
                                                    @else
                                                        {{'readonly'}}
                                                    @endif
                                                    type="text" value="@if(isset($Item['rWdBRating'])){{$Item['rWdBRating']}}@endif">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group input-icons">
                                                    ...
                                                    <i class="fa fa-info icon cursor-pointer" id="perimeterSeal1Icon"></i>
                                                    <input type="text" readonly id="perimeterSeal1" class="form-control">
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group input-icons">
                                                    ...
                                                    <i class="fa fa-info icon cursor-pointer" id="perimeterSeal2Icon"></i>
                                                    <input type="text" readonly id="perimeterSeal2" class="form-control">
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group input-icons">
                                                    ...
                                                    <i class="fa fa-info icon cursor-pointer " id="thresholdSeal1Icon"></i>
                                                    <input type="text" readonly id="thresholdSeal1"class="form-control">
                                                    <input type="hidden" name="thresholdSeal1">
                                       ...
                                       {{--   <div class="col-md-6">
                                                <div class="position-relative form-group input-icons">
                                                    ...
                                                    <i class="fa fa-info icon cursor-pointer" id="thresholdSeal2Icon"></i>
                                                    <input type="text" readonly id="thresholdSeal2"class="form-control">
                                                    <input type="hidden" name="thresholdSeal2">
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group input-icons">
                                                    ...
                                                    <i class="fa fa-info icon cursor-pointer"id="accousticsmeetingStilesIcon"></i>
                                                    <input type="text" readonly id="accousticsmeetingStiles"class="form-control">
                                                    <input type="hidden" name="accousticsmeetingStiles">
