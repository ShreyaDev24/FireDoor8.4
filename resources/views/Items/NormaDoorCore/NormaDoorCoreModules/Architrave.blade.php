                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group input-icons">
                                                    ...
                                                    <input  type="text" id="architraveMaterial" class="form-control" readonly>
                                                    <input type="hidden" name="architraveMaterial"
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <select  name="architraveType" id="architraveType"
                                                        @if(isset($Item['Architrave']))
                                                            @if($Item['Architrave'] != "Yes")
                                                                {{'disabled'}}
                                                            @endif
                                                        ...
                                                        <option value="{{$row->OptionKey}}" @if(isset($Item['ArchitraveType'])) @if($Item['ArchitraveType'] == $row->OptionKey) {{'selected'}} @endif @endif>{{$row->OptionValue}}</option>
                                                        @endif
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    <label for="architraveHeight">Architrave Height
                                                    ...
                                                    <input name="architraveHeight" id="architraveHeight" 
                                                        ...
                                                        @else
                                                            {{'readonly'}}
                                                        @endif 
                                                        placeholder="Architrave Height" class="form-control" type="text"
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group input-icons">
                                                    ...
                                                    <input type="text" id="architraveFinishcolor" class="form-control" readonly>
                                                    <input type="hidden" name="architraveFinishcolor"
                                                        value="@if(isset($Item['architraveFinishcolor'])){{$Item['architraveFinishcolor']}}@endif">
                                                    <!-- <select name="architraveFinishcolor" id="architraveFinishcolor"
                                                        @if(isset($Item['Architrave']))
                                                            @if($Item['Architrave'] != "Yes")
                                                                {{'disabled'}}
                                                            @endif
                                                     ...
                                                     class="form-control">
                                                        <option value="">Architrave  Finish  Color</option>
                                                        </select>   -->
                                                </div>
                                            </div>
                                            <div class="col-md-6">
