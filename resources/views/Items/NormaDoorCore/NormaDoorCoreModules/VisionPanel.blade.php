                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input readonly Type="number" min="0" name="glazingBeadsWidth" id="glazingBeadsWidth"
                                class="form-control"
                                value="@if(isset($Item['glazingBeadsWidth'])){{$Item['glazingBeadsWidth']}}@endif">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input readonly Type="number" min="0" name="glazingBeadsHeight"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input readonly type="text" name="glazingBeadsFixingDetail"
