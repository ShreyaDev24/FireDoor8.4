                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group input-icons">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->architraveMaterial}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->architraveType}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->architraveWidth}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->architraveHeight}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                            ...
                                            {{-- <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->architraveDepth}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->architraveFinish}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group input-icons">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->architravefinishColor}}'));
                                                    </script>
                                                    @endif
                                                 </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->architraveSetQty}}'));
                                                    </script>
                                                    @endif
                                                    </label>
