                   ...
                   <div class="form-row">
                       {{--  <div class="col-md-6">
                           <div class="position-relative form-group">
                               <label for="leafConstruction">Leaf Construction
                                   ...
                                   //(Tooltip('{{$tooltip->leafConstruction}}'));
                                   </script>
                                   @endif
                               </label>
                       ...
                       <div class="col-md-6">
                           <div class="position-relative form-group">
                               ...
                               <input type="text" required name="Handing" id="Handing" class="form-control" value="@if(isset($Item["Handing"])){{$Item["Handing"]}}@else{{''}}@endif">
                           </div>
                       </div>
                       <div class="col-md-6">
                           <div class="position-relative form-group">
                       ...
                       <div class="col-md-6">
                           <div class="position-relative form-group">
                               <label for="frameThickness">Frame Thickness
                                   ...
                                   <script type="text/javascript">
                                   //(Tooltip('{{$tooltip->frameThickness}}'));
                                   </script>
                                   @endif
                               </label>
                       ...
                       <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->ironmongerySet}}'));
                            </script>
                            @endif
                            </label>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->selectironmongerySet}}'));
                            </script>
                            @endif
                            </label>
