                ...
                <div class="form-row">
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            //(Tooltip('{{$tooltip->leaf1VisionPanel}}'));
                            </script>
                            @endif
                            </label>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->leaf1VisionPanelShape}}'));
                            </script>
                            @endif
                            </label>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->visionPanelQuantity}}'));
                            </script>
                            @endif
                            </label>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->AreVPsEqualSizes}}'));
                            </script>
                            @endif
                            </label>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->distanceFromTopOfDoor}}'));
                            </script>
                            @endif
                                </label>
                            <input type="number"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->distanceFromTheEdgeOfDoor}}'));
                            </script>
                            @endif
                                </label>
                            <input type="number"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->distanceBetweenVPs}}'));
                            </script>
                            @endif
                            </label>
                            <input type="number"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->leaf1VpAreaSizeM2}}'));
                            </script>
                            @endif
                            </label>
                            <input type="number"
                        ...
                        <div class="position-relative form-group">
                            <label for="leaf2VisionPanel">Leaf 2 Vision Panel
                                @if(!empty($tooltip->leaf2VisionPanel))
                                    <script type="text/javascript">
                                        //(Tooltip('{{$tooltip->leaf2VisionPanel}}'));
                                    </script>
                                @endif
                            </label>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->visionPanelQuantityforLeaf2}}'));
                            </script>
                            @endif
                                </label>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->AreVPsEqualSizesForLeaf2}}'));
                            </script>
                            @endif
                                </label>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->distanceFromTopOfDoorforLeaf2}}'));
                            </script>
                            @endif
                                </label>
                            <input type="number"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->distanceFromTheEdgeOfDoorforLeaf2}}'));
                            </script>
                            @endif
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->distanceBetweenVPsforLeaf2}}'));
                            </script>
                            @endif
                                </label>
                            <input type="number"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->lazingIntegrityOrInsulationIntegrity}}'));
                            </script>
                            @endif
                                </label>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->glassThickness}}'));
                            </script>
                            @endif
                            </label>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->glazingSystems}}'));
                            </script>
                            @endif
                            </label>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->glazingSystemsThickness}}'));
                            </script>
                            @endif
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            <label for="glazingBeadsThickness">Glazing Beads Thickness
                            @if(!empty($tooltip->glazingBeadsThickness))
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->glazingBeadsThickness}}'));
                            </script>
                            @endif
                            </label>
                    ...
                    {{-- <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->glazingBeadsWidth}}'));
                            </script>
                            @endif
                            </label> --}}
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->glazingBeadsHeight}}'));
                            </script>
                            @endif
                            </label>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->glazingBeadsFixingDetail}}'));
                            </script>
                            @endif
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <script type="text/javascript">
                            //(Tooltip('{{$tooltip->glazingBeadSpecies}}'));
                            </script>
                            @endif
