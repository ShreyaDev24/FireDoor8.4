                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->plantonStopWidth}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->plantonStopHeight}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                            ...
                                            <div class="col-md-6" hidden>
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->frameTypeDimensions}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                ...
                                <div class="position-relative form-group">
                                    <label for="frameThickness1">Frame Thickness</label>
                                     <input name="frameThickness1" required placeholder="Frame Thickness"
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    <label for="framefinishColor">Frame Finish
                                                    @if(!empty($tooltip->framefinishColor))
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->framefinishColor}}'));
                                                    </script>
                                                    @endif
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group input-icons">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->frameCostuction}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->extLinerThickness}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->extLinerFinish}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                          ...
                                          <option value="Fire and Smoke" @if(isset($Item['IntumescentLeapingSealType'])) @if($Item['IntumescentLeapingSealType'] == "Fire and Smoke") {{'selected'}} @endif @endif>Fire and Smoke</option>
                                            ...
                                            <!-- <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->intumescentSeal}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                            ...
                                            <!-- <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->intumescentSealSize}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->specialFeatureRefs}}'));
                                                    </script>
                                                    @endif
                                                    </label>
