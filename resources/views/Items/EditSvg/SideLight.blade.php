                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->sideLight1GlassType}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->SideLight1BeadingType}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group input-icons">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->SideLight1GlazingBeadSpecies}}'));
                                                    </script>
                                                    @endif
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->copyOfSideLite1}}'));
                                                    </script>
                                                    @endif
                                                        </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->sideLight2GlassType}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                        ...
                                        @endforeach -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->SideLight2BeadingType}}'));
                                                    </script>
                                                    @endif
                                                        </label>
                                        ...
                                        @endforeach -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group input-icons">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->SideLight2GlazingBeadSpecies}}'));
                                                    </script>
                                                    @endif
                                                        </label>
                                                ...
                                                <div class="position-relative form-group input-icons">
                                                    <label for="SLtransomHeightFromTop">Transom height from top
                                                        @if(!empty($tooltip->SLtransomHeightFromTop))
                                                            <script type="text/javascript">
                                                                //(Tooltip('{{$tooltip->SLtransomHeightFromTop}}'));
                                                            </script>
                                                        @endif
                                                    </label>
                                                ...
                                                <div class="position-relative form-group input-icons">
                                                    <label for="SLtransomThickness">Transom Thickness (Min 32mm)
                                                        @if(!empty($tooltip->SLtransomThickness))
                                                            <script type="text/javascript">
                                                                //(Tooltip('{{$tooltip->SLtransomThickness}}'));
                                                            </script>
                                                        @endif
                                                    </label>
