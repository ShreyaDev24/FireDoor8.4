                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->lippingThickness}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group input-icons">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->lippingSpecies}}'));
                                                    </script>
                                                    @endif
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->scallopedLippingThickness}}'));
                                                    </script>
                                                    @endif
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->flatLippingThickness}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->rebatedLippingThickness}}'));
                                                    </script>
                                                    @endif
                                                        </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->intumescentSealType}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->intumescentSealLocation}}'));
                                                    </script>
                                                    @endif
                                                        </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->intumescentSealColor}}'));
                                                    </script>
                                                    @endif
                                                    </label>
                                                    <select name="intumescentSealColor" id="intumescentSealColor"  option_slug = "Intumescent_Seal_Color"
                                                        ...
                                                        <option value="{{$row->OptionKey}}" @if(isset($Item['IntumescentLeapingSealColor'])) @if($Item['IntumescentLeapingSealColor'] == $row->OptionKey) {{'selected'}} @endif @endif>{{$row->OptionValue}}</option>
                                                        @endif
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                    //(Tooltip('{{$tooltip->intumescentSealArrangement}}'));
                                                    </script>
                                                    @endif
                                                        </label>
                                                    ...
                                                    <select name="intumescentSealArrangement" id="intumescentSealArrangement" class="form-control" option_slug = "intumescentSealArrangement"></select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 intumescentSealMeetingEdgesDiv" style="@if(!@$Item['intumescentSealMeetingEdges']) display:none @endif">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <script type="text/javascript">
                                                        //(Tooltip('{{$tooltip->intumescentSealMeetingEdges}}'));
                                                    </script>
                                                    @endif
                                                        </label>
