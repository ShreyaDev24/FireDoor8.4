                ...
                <form id="itemForm" enctype="multipart/form-data" >
                    ...
                    <div class="tab-content">
                        <div id="main-options-section" class="tab-pane active">
                            @include("Items.Deanta.DeantaDoorModules.MainOptions")
                         </div>

                        <div id="door-dimensions-n-door-leaf-section" class="tab-pane fade">
                            @include("Items.Deanta.DeantaDoorModules.DoorDimensionsAndDoorLeaf")
                        </div>

                        <div id="vision-panel-section" class="tab-pane fade">
                            @include("Items.Deanta.DeantaDoorModules.VisionPanel")
                        </div>

                        <div id="frame-section" class="tab-pane fade framehideshow">
                            @include("Items.Deanta.DeantaDoorModules.Frame")
                        </div>

                        <div id="over-panel-section" class="tab-pane fade framehideshow">
                            @include("Items.Deanta.DeantaDoorModules.OverPanel")
                        </div>

                        <div id="side-light-section" class="tab-pane fade framehideshow">
                            @include("Items.Deanta.DeantaDoorModules.SideLight")
                        </div>

                        <div id="lipping-and-intumescent-section" class="tab-pane fade">
                            @include("Items.Deanta.DeantaDoorModules.LippingAndIntumescent")
                        </div>

                        <div id="accoustics-section" class="tab-pane fade">
                            @include("Items.Deanta.DeantaDoorModules.Accoustics")

                        </div>

                        <div id="architrave-section" class="tab-pane fade framehideshow">
                            @include("Items.Deanta.DeantaDoorModules.Architrave")
                        </div>

                        <div id="transport-section" class="tab-pane fade">
                            @include("Items.Deanta.DeantaDoorModules.Transport")
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                ...
                <div class="tab-content item-form" id="opDiv">
                    ...
                    <div id="BuildOfMaterial" class="tab-pane table-responsive">
                      ...
                      @include("Items.Deanta.DeantaBuildOfMaterialForCadDoor")

                    </div>
                    <div id="doorPrice" class="tab-pane table-responsive" >
                        @include("Items.Deanta.DoorPriceForCadDoor")
                    </div>
                </div>
            </div>
        </div>
...
<script src="{{url('/')}}/Deanta/Deanta-build-of-material-for-cad-door.js"></script>
<script src="{{asset('Deanta/Deanta-custome-rules.js')}}"></script>
<script src="{{asset('Deanta/Deanta-change-event-calculation.js')}}"></script>
