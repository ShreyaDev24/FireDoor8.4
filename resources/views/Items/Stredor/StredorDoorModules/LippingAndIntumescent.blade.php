                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="number" min="1" readonly id="opCoreWidth" name="opCoreWidth"
                                class="form-control coreWidth1" value="@if(isset($Item['OPCoreWidth'])){['OPCoreWidth']}}@endif">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="number" min="1" readonly id="opCoreHeight" name="opCoreHeight"
                                class="form-control coreWidth1" value="@if(isset($Item['OPCoreHeight']))['OPCoreHeight']}}@endif">
                        </div>
                 </div>
