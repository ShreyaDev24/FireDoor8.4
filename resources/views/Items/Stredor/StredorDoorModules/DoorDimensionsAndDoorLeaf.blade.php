        ...
        <div class="tab-content">
            ...
            <div>
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            <label for="grooveLocation">Groove Location Leaf2
                                @if(!empty($tooltip->grooveLocation))
                                <script type="text/javascript">
                                document.write(Tooltip('{{$tooltip->grooveLocation}}'));
                                </script>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="number" max="10" name="GrooveWidthLeaf2" id="GrooveWidthLeaf2" class="form-control"
                                value="@if(!empty($Item['GrooveWidthLeaf2'])){{$Item['GrooveWidthLeaf2']}}@endif">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="number" name="GrooveDepthLeaf2" id="GrooveDepthLeaf2" class="form-control"
                                value="@if(!empty($Item['GrooveDepthLeaf2'])){{$Item['GrooveDepthLeaf2']}}@endif">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="number" pattern="\d*" name="MaxNumberOfGrooveLeaf2" id="MaxNumberOfGrooveLeaf2"
                                class="form-control" @if(isset($Item['GrooveLocationLeaf2']))
                                @if($Item['GrooveLocationLeaf2']=='Vertical_&_Horizontal' ) {{'readonly'}} @endif @endif
                                value="@if(!empty($Item['MaxNumberOfGrooveLeaf2'])){{$Item['MaxNumberOfGrooveLeaf2']}}@else{{'0'}}@endif">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="number" name="NumberOfGrooveLeaf2" @if(isset($Item['GrooveLocationLeaf2']))
                                @if($Item['GrooveLocationLeaf2']=='Vertical_&_Horizontal' ) {{'readonly'}} @endif @endif
                                id="NumberOfGrooveLeaf2" class="form-control"
                                value="@if(isset($Item['NumberOfGrooveLeaf2'])){{$Item['NumberOfGrooveLeaf2']}}@else{{'0'}}@endif">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            <label for="numberOfVerticalGroove">No. of Vertical Grooves(Max 4) Leaf2
                                @if(!empty($tooltip->numberOfVerticalGroove))
                                <script type="text/javascript">
                                document.write(Tooltip('{{$tooltip->numberOfVerticalGroove}}'));
                                </script>
                            ...
                            <input type="number" max="4" name="NumberOfVerticalGrooveLeaf2"
                                @if(isset($Item['GrooveLocationLeaf2'])) @if($Item['GrooveLocationLeaf2']
                                !='Vertical_&_Horizontal' ) {{'readonly'}} @endif @else {{'readonly'}} @endif
                                id="NumberOfVerticalGrooveLeaf2" class="form-control"
                                value="@if(isset($Item['NumberOfVerticalGrooveLeaf2'])){{$Item['NumberOfVerticalGrooveLeaf2']}}@else{{'0'}}@endif">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            <label for="numberOfHorizontalGroove">No. of Horizontal Grooves Leaf2(Max 4)
                                @if(!empty($tooltip->numberOfHorizontalGroove))
                                <script type="text/javascript">
                                document.write(Tooltip('{{$tooltip->numberOfHorizontalGroove}}'));
                                </script>
                            ...
                            <input type="number" name="NumberOfHorizontalGrooveLeaf2" @if(isset($Item['GrooveLocationLeaf2']))
                                @if($Item['GrooveLocationLeaf2'] !='Vertical_&_Horizontal' ) {{'readonly'}} @endif @else
                                {{'readonly'}} @endif id="NumberOfHorizontalGrooveLeaf2" max="4" class="form-control"
                                value="@if(isset($Item['NumberOfHorizontalGrooveLeaf2'])){{$Item['NumberOfHorizontalGrooveLeaf2']}}@else{{'0'}}@endif">
                        </div>
                    </div>
                </div>
            </div>
