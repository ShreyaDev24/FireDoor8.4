                ...
                <div class="form-row">
                    <div class="col-md-6">
                        <div class="position-relative form-group input-icons">
                            ...
                            <input type="text" required readonly id="frameMaterial" class="form-control bg-white"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <select name="frameType" required id="frameType" class="form-control">
                                ...
                                <option value="{{$row->OptionKey}}" @if(isset($Item['FrameType']))
                                    @if($Item['FrameType']==$row->OptionKey) {{'selected'}} @endif
                                    @endif>{{$row->OptionValue}}</option>
                                @endif
                                @endforeach
                            </select>
                        </div>
                        <input type="hidden" id="frametypevalue" name="frametypevalue"
                            value="@if(isset($Item['FrameType'])){{$Item['FrameType']}}@endif">
                    </div>
                    <input type="hidden" id="frametypevalue" name="frametypevalue"
                        value="@if(isset($Item['FrameType'])){{$Item['FrameType']}}@endif">
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            <label for="plantonStopWidth" id="plantonStopWidthLabel">Plant on Stop Width <span
                                    id="plantonStopWidthText"></span>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="number" @if(empty($Item['PlantonStopHeight'])){{'readonly'}}@endif min="12"
                                name="plantonStopHeight" id="plantonStopHeight" class="form-control"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            <label for="rebatedHeight">Scalloped Depth <span id="ScallopedHeightText"></span>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            <label for="rebatedWidth" id="rebatedWidthLabel">Rebated Width <span
                                    id="rebatedWidthText"></span>
                    ...
                    <input type="hidden" id="rebatedwidthnew" name="rebatedwidthnew"
                        value="@if(isset($Item['RebatedWidth'])){{$Item['RebatedWidth']}}@endif">
                    <input type="hidden" id="rebatedHeightnew" name="rebatedHeightnew"
                        value="@if(isset($Item['RebatedHeight'])){{$Item['RebatedHeight']}}@endif">
                    <div class="col-md-6" hidden>
                        <div class="position-relative form-group">
                            ...
                            <input type="number" name="frameTypeDimensions" min="1"
                                @if(empty($Item['FrameTypeDimensions'])){{'readonly'}}@endif id="frameTypeDimensions"
                                class="form-control"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="text" name="frameWidth" id="frameWidth" placeholder="Frame Width"
                                class="form-control"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="text" name="frameHeight" placeholder="Frame Height" id="frameHeight"
                                class="form-control"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <select name="frameFinish" id="frameFinish" class="form-control change-event-calulation">
                                ...
                                <option value="{{$row->OptionKey}}" @if(isset($Item['FrameFinish']))
                                    @if($Item['FrameFinish']==$row->OptionKey) {{'selected'}} @endif
                                    @endif>{{$row->OptionValue}}</option>
                                @endif
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="hidden" id="FrameFinishColor-value"
                                value="@if(isset($Item['FrameFinishColor'])){{$Item['FrameFinishColor']}}@endif">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <select name="extLiner" id="extLiner" class="form-control change-event-calulation">
                                ...
                                <option value="{{$row->OptionKey}}" @if(isset($Item['ExtLiner']))
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group input-icons">
                            ...
                            @endforeach
                            @endif
                            <i class="fa fa-info icon cursor-pointer" id="frameCostuction"
                                onClick="$('#DoorFrameConstructionModal').modal('show')"></i>
                            <input type="text" readonly id="frameCostuction"
                                value="@if(isset($DoorFrameConstruction)){{$DoorFrameConstruction}}@endif"
                                class="form-control bg-white">
                            <input type="hidden" name="frameCostuction" id="mydoor"
                                value="@if(isset($Item['DoorFrameConstruction'])){{$Item['DoorFrameConstruction']}}@endif">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="text" @if(empty($Item['ExtLinerValue'])){{'readonly'}}@endif
                                name="extLinerValue" id="extLinerValue" class="form-control"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="extLinerThickness" @if(empty($Item['ExtLinerThickness'])){{'readonly'}}@endif
                                id="extLinerThickness" placeholder="Ext-Liner Thickness"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="extLinerFinish" id="extLinerFinish" readonly placeholder="Ext-Liner Finish"
