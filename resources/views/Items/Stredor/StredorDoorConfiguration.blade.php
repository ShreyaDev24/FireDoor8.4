            ...
            <div class="col-md-6">
                ...
                <div class="item-form">
                    <form id="itemForm" enctype="multipart/form-data">
                        <input type="hidden" name="pageIdentity" id="pageIdentity" value="8">
                        ...
                        <div class="tab-content">
                            <div id="main-options-section" class="tab-pane active">
                                @include("Items.Stredor.StredorDoorModules.MainOptions")
                            </div>

                            <div id="door-dimensions-n-door-leaf-section" class="tab-pane fade">
                                @include("Items.Stredor.StredorDoorModules.DoorDimensionsAndDoorLeaf")
                            </div>

                            <div id="vision-panel-section" class="tab-pane fade">
                                @include("Items.Stredor.StredorDoorModules.VisionPanel")
                            </div>

                            <div id="frame-section" class="tab-pane fade framehideshow">
                                @include("Items.Stredor.StredorDoorModules.Frame")
                            </div>

                            <div id="over-panel-section" class="tab-pane fade framehideshow">
                                @include("Items.Stredor.StredorDoorModules.OverPanel")
                            </div>

                            <div id="side-light-section" class="tab-pane fade framehideshow">
                                @include("Items.Stredor.StredorDoorModules.SideLight")
                            </div>

                            <div id="lipping-and-intumescent-section" class="tab-pane fade">
                                @include("Items.Stredor.StredorDoorModules.LippingAndIntumescent")
                            </div>

                            <div id="acoustics-section" class="tab-pane fade">
                                @include("Items.Stredor.StredorDoorModules.Accoustics")

                            </div>

                            <div id="architrave-section" class="tab-pane fade framehideshow">
                                @include("Items.Stredor.StredorDoorModules.Architrave ")
                            </div>

                            <div id="transport-section" class="tab-pane fade">
                                <!-- @include("Items.Stredor.StredorDoorModules.Transport") -->
                            </div>
                        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="tab-content" id="opDiv">
                    ...
                    <div id="BuildOfMaterial" class="tab-pane table-responsive">
                        ...
                        @include("Items.Stredor.StredorBuildOfMaterialForCadDoor")

                    </div>

                    <div id="doorPrice" class="tab-pane table-responsive" >
                        @include("Items.Stredor.StredorDoorPriceForCadDoor")
                    </div>
                </div>
            </div>
        </div>
...
<script src="{{url('/')}}/Stredor/stredor-build-of-material-for-cad-door.js"></script>
<script src="{{asset('Stredor/stredor-custome-rules.js')}}"></script>
<script src="{{asset('Stredor/stredor-change-event-calculation.js')}}"></script>
...
<script>
    ...
    function defaultimport(){
        $("select[name=intumescentLeafType]").val(18).trigger("change");
