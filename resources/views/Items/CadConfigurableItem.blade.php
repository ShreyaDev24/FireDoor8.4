                    ...
                    <form id="itemForm" enctype="multipart/form-data">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="lipping-and-intumescent-section" class="tab-pane fade">
                                @include("Items.CadDoorModules.LippingAndIntumescent")
                            </div>

                            <div id="acoustics-section" class="tab-pane fade">
                                @include("Items.CadDoorModules.Accoustics")

                            </div>

                            <div id="architrave-section" class="tab-pane fade framehideshow">
                                @include("Items.CadDoorModules.Architrave ")
                            </div>

                            <div id="transport-section" class="tab-pane fade">
                                 <!-- @include("Items.CadDoorModules.Transport") -->
                            </div>
                        </div>
...
<script>
    ...
    function defaultimport(){
        $("select[name=intumescentLeafType]").val($("#IntumescentLeafType-import").data("value")).trigger("change");
...
$(document).ready(function() {
    ...
    SideGlassTypeChange(null,'sideLight2GlassType',true);
    @endif
