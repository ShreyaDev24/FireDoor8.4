    ...
    <div class="main-card mb-3 card">
       <input type="hidden" name="_token" id="_token" value="{{ csrf_token() }}">
                    ...
                    <!-- <div class="col-md-3">
                        ...
                        <!-- <div class="col-md-3">
                          ...
                          <div class="col-md-3">
                            ...
                            <input name="doorType" id="doorType"  required placeholder="Enter door type" type="text" value="" class="form-control"></div>
                        </div>
                        <div class="col-md-3">
                            <div class="position-relative form-group">
                                <label for="DoorNo" class="">Door No.</label>
                                <input name="DoorNo" id="DoorNo"  required placeholder="Enter door number" type="text" value="" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="position-relative form-group">
                                ...
                                <!-- combination_of -->
                                <select required name="doorsetType" id="doorsetType" class="form-control combination_of change-event-calulation">
                        ...
                        <div class="col-md-3">
                            <div class="position-relative form-group">
                                <label for="Handing" class="">Handing</label>
                        ...
                        <div class="col-md-3">
                            <div class="position-relative form-group">
                                <label for="OpensInwards" class="">Pull Towards </span></label>
                ...
                <div class="card-body">
                   ...
                   <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="position-relative form-group">
                                ...
                                <input type="number" readonly id="leafWidth2" name="leafWidth2" class="form-control forcoreWidth1">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="position-relative form-group">
                   ...
                   <div class="col-md-3">
                      <div class="position-relative form-group">
                        ...
                        <div class="doorLeafFinishDiv">
                          ...
                          <select name="doorLeafFinish" id="doorLeafFinish" class="form-control doorLeafFinishSelect">
                   ...
                   <div class="col-md-3">
                      <div class="position-relative form-group">
                        ...
                        <div class="input-icons">
                            ...
                            <input type="text"  readonly name="doorLeafFinishColor" id="doorLeafFinishColor"  class="form-control" >
                   ...
                   <div class="col-md-3">
                      <div class="position-relative form-group">
                        <label for="grooveLocation" class="">Groove Location</label>
                   ...
                   <div class="col-md-3">
                      <div class="position-relative form-group">
                        <label for="grooveWidth" class="">Groove Width(Max 10 mm)</label>
                   ...
                   <div class="col-md-3">
                      <div class="position-relative form-group">
                        <label for="grooveDepth" class="">Groove Depth</label>
                        <input type="number" name="grooveDepth" id="grooveDepth" class="form-control">
                      </div>
                   </div>
                   <div class="col-md-3">
                      <div class="position-relative form-group">
                        <label for="maxNumberOfGroove" class=""> Maximum Number of Groove </label>
                   ...
                   <div class="col-md-3">
                      <div class="position-relative form-group">
                        <label for="numberOfGroove" class="">Number of Grooves</label>
                        <input type="number" value="0" name="numberOfGroove" id="numberOfGroove" class="form-control">
                      </div>
                   </div>
                   <div class="col-md-3">
                      <div class="position-relative form-group">
                        <label for="numberOfVerticalGroove" class="">Number of Vertical Grooves(Max 4) </label>
                        <input type="number" value="0" max="4" name="numberOfVerticalGroove" id="numberOfVerticalGroove" class="form-control">
                      </div>
                   </div>
                   <div class="col-md-3">
                      <div class="position-relative form-group">
                        <label for="numberOfHorizontalGroove" class="">Number of Horizontal Grooves(Max 4)</label>
                        <input type="number" value="0" name="numberOfHorizontalGroove" id="numberOfHorizontalGroove" max="4" class="form-control">
                      </div>
                   </div>
            ...
            <div class="main-card mb-3 card">
                ...
                <div class="card-body">
                 ...
                 <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="position-relative form-group">
                            <label for="leaf1VisionPanelShape" class="">Vision Panel Shape</label>
                            <select required name="leaf1VisionPanelShape" id="leaf1VisionPanelShape" class="form-control change-event-calulation">
                    ...
                    <div class="col-md-3">
                        <div class="position-relative form-group">
                            <label for="distanceFromTheEdgeOfDoor" class="">Distance from the edge</label>
                            <input required Type="number" readonly min="100" name="distanceFromTheEdgeOfDoor" id="distanceFromTheEdgeOfDoor" class="form-control">
                            </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="position-relative form-group">
                            <label for="distanceFromTheEdgeOfDoorforLeaf2" class="">Distance from the edge for Leaf 2</label>
                            <input required Type="number" readonly min="100" name="distanceFromTheEdgeOfDoorforLeaf2" id="distanceFromTheEdgeOfDoorforLeaf2" class="form-control">
                            </div>
                    </div>
                    ...
                    <div class="col-md-3">
                     ...
                     <div class="col-md-3">
                        <div class="position-relative form-group">
                            <label for="glazingBeadsWidth" class="">Glazing Beads Width</label>
                            <input Type="number" min="0" name="glazingBeadsWidth" id="glazingBeadsWidth" class="form-control">
                        </div>
                     </div>

                    <div class="col-md-3">
                        <div class="position-relative form-group">
                            <label for="glazingBeadsHeight" class="">Glazing Beads Height</label>
                            <input Type="number" min="0" name="glazingBeadsHeight" id="glazingBeadsHeight" class="form-control">
                        </div>
                    </div>

                    <div class="col-md-3">
                        <div class="position-relative form-group">
                            <label for="glazingBeadsFixingDetail" class="">Glazing Bead Fixing Detail</label>
                            <input Type="number" min="0" name="glazingBeadsFixingDetail" id="glazingBeadsFixingDetail" class="form-control">
                        </div>
                    </div>
    ...
    <div class="main-card mb-3 card">
                ...
                <div class="card-body">
                 <div class="form-row">
                    <div class="col-md-3">
                        ...
                        {{--</select>--}}
                         ...
                         <div class="input-icons">
                              ...
                              <input type="text" readonly name="frameMaterial" id="frameMaterial"  class="form-control bg-white" >
                    ...
                    <div class="col-md-3">
                        <div class="position-relative form-group">
                        <label for="plantonStopWidth" class="">Plant on Stop Width(max 32)</label>
                        <input type="number" readonly max="32" name="plantonStopWidth" value="0"  id="plantonStopWidth" class="form-control">

                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="position-relative form-group">
                        <label for="plantonStopHeight" class="">Plant on Stop Height(max 12)</label>
                        <input type="number" readonly max="12" name="plantonStopHeight" value="0"  id="plantonStopHeight" class="form-control">
                    ...
                    <div class="col-md-3">
                        <div class="position-relative form-group">
                            <label for="frameWidth" class="">Frame Width</label>
                             <input type="text" name="frameWidth" id="frameWidth" placeholder="Frame Width" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="position-relative form-group">
                            <label for="frameHeight" class="">Frame Height</label>
                            <input type="text" name="frameHeight" placeholder="Frame Height" id="frameHeight" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="position-relative form-group">
                    ...
                    <input name="frameThickness1"  id="frameThickness1" min="0" type="hidden" class="form-control">
                    ...
                    <div class="col-md-3">
                      <div class="position-relative form-group">
                        <label for="framefinishColor" class="">Frame finish Color</label>
                   ...
                   <div class="col-md-3">
                      <div class="position-relative form-group">
                        <label for="frameCostuction" class="">Door Frame Construction</label>
                        <select  name="frameCostuction" id="frameCostuction"  class="form-control change-event-calulation">
                   ...
                   <div class="col-md-3">
                      <div class="position-relative form-group">
                        ...
                        <input name="extLinerSize" readonly id="extLinerSize" placeholder="Ext-Liner Size" class="form-control" type="text">
                      </div>
                   </div>
                   <div class="col-md-3">
                      <div class="position-relative form-group">
                        <label for="extLinerThickness" class="">Ext-Liner Thickness</label>
                        <input name="extLinerThickness" readonly id="extLinerThickness" placeholder="Ext-Liner Thickness" class="form-control change-event-calulation" type="text">
                      </div>
                   </div>
                   <div class="col-md-3">
                      <div class="position-relative form-group">
                ...
                <div class="card-body">
                 ...
                 <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="position-relative form-group">
                                <label for="coreWidth2" class="">Core Width 2</label>
                                <input type="number" min="1" readonly id="coreWidth2" name="coreWidth2" class="form-control coreWidth1">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="position-relative form-group">
                                <label for="coreHeight" class="">Core Height</label>
                                <input type="number" min="1" readonly id="coreHeight" name="coreHeight" class="form-control coreWidth1">
                            </div>
                        </div>
...
<div class="main-card mb-3 card">
                ...
                <div class="card-body">
                 ...
                 <div class="col-md-3">
                      <div class="position-relative form-group">
                        <label for="Architrave" class="">Architrave</label>
                ...
                <div class="card-body">
                 ...
                 <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <input type="text"  readonly name="hingesKey" id="HingesKey"  class="form-control bg-white" >
                          </div>
                    ...
                    <div class="col-md-3">
                        <div class="position-relative form-group">
                          ...
                          <div class="input-icons">
                              ...
                              <input type="text"  readonly name="floorSpringKey" id="FloorSpringKey"  class="form-control bg-white" >
                          </div>
                    ...
                    <div class="col-md-3">
                        <div class="position-relative form-group">
                          ...
                          <div class="input-icons">
                              ...
                              <input type="text"  readonly name="lockesAndLatchesKey" id="LocksandLatchesKey"  class="form-control bg-white" >
                          </div>
                    ...
                    <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="flushBoltsKey" id="FlushBoltsKey"  class="form-control bg-white" >
                          </div>
                ...
                <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="concealedOverheadCloserKey" id="OverheadClosersKey"  class="form-control bg-white" >
                          </div>
                ...
                <div class="col-md-3">
                        <div class="position-relative form-group">
                          ...
                          <div class="input-icons">
                              ...
                              <input type="text"  readonly name="pullHandlesKey" id="PullHandlesKey"  class="form-control bg-white" >
                          </div>
                      </div>
                </div>
                <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="pushHandlesKey" id="PushHandlesKey"  class="form-control bg-white" >
                          </div>
                ...
                <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="kickPlatesKey" id="KickPlatesKey"  class="form-control bg-white" >
                          </div>
                ...
                <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="doorSelectorsKey" id="DoorSelectorsKey"  class="form-control bg-white" >
                          </div>
                ...
                <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="panicHardwareKey" id="PanicHardwareKey"  class="form-control bg-white" >
                          </div>
                ...
                <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="doorSecurityViewerKey" id="DoorsecurityviewerKey"  class="form-control bg-white" >
                          </div>
                ...
                <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="morticeddropdownsealsKey" id="MorticeddropdownsealsKey"  class="form-control bg-white" >
                          </div>
                      </div>
                </div>
                <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="facefixeddropsealsKey" id="FacefixeddropsealsKey"  class="form-control bg-white" >
                          </div>
                ...
                <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="thresholdSealKey" id="ThresholdSealKey"  class="form-control bg-white" >
                          </div>
                ...
                <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="airtransfergrillsKey" id="AirtransfergrillsKey"  class="form-control bg-white" >
                          </div>
                    ...
                    <div class="col-md-3">
                      <div class="position-relative form-group">
                        ...
                        <div class="input-icons">
                              ...
                              <input type="text"  readonly name="letterplatesKey" id="LetterplatesKey"  class="form-control bg-white" >
                          </div>
                        </div>
                   </div>
                <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="cableWaysKey" id="CableWaysKey"  class="form-control bg-white" >
                          </div>
                ...
                <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="safeHingeKey" id="SafeHingeKey"  class="form-control bg-white" >
                        </div>
                ...
                <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="leverHandleKey" id="LeverHandleKey"  class="form-control bg-white" >
                          </div>
                ...
                <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="doorSignageKey" id="DoorSignageKey"  class="form-control bg-white" >
                          </div>
                ...
                <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="faceFixedDoorClosersKey" id="FaceFixedDoorClosersKey"  class="form-control bg-white" >
                          </div>
                ...
                <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="thumbturnKey" id="ThumbturnKey"  class="form-control bg-white" >
                          </div>
                ...
                <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-icons">
                              ...
                              <input type="text"  readonly name="keyholeEscutcheonKey" id="KeyholeEscutcheonKey"  class="form-control bg-white" >
                          </div>
...
<div class="modal fade bd-example-modal-lg" id="frameMaterialModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
