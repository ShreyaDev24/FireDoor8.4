                ...
                <form id="itemForm" enctype="multipart/form-data" >
                    ...
                    <div class="tab-content">
                        ...
                        <div id="door-dimensions-n-door-leaf-section" class="tab-pane fade">
                            @include("Items.Vicaima.VicaimaDoorModules.DoorDimensionsAndDoorLeaf")
                        </div>

                        <div id="vision-panel-section" class="tab-pane fade">
                            @include("Items.Vicaima.VicaimaDoorModules.VisionPanel")
                        </div>

                        <div id="frame-section" class="tab-pane fade framehideshow">
                            @include("Items.Vicaima.VicaimaDoorModules.Frame")
                        </div>

                        <div id="over-panel-section" class="tab-pane fade framehideshow">
                            @include("Items.Vicaima.VicaimaDoorModules.OverPanel")
                        </div>

                        <div id="side-light-section" class="tab-pane fade framehideshow">
                            @include("Items.Vicaima.VicaimaDoorModules.SideLight")
                        </div>

                        <div id="lipping-and-intumescent-section" class="tab-pane fade">
                            @include("Items.Vicaima.VicaimaDoorModules.LippingAndIntumescent")
                        </div>

                        <div id="accoustics-section" class="tab-pane fade">
                            @include("Items.Vicaima.VicaimaDoorModules.Accoustics")

                        </div>

                        <div id="architrave-section" class="tab-pane fade framehideshow">
                            @include("Items.Vicaima.VicaimaDoorModules.Architrave")
                        </div>

                        <div id="transport-section" class="tab-pane fade">
                            @include("Items.Vicaima.VicaimaDoorModules.Transport")
                        </div>
                    </div>
...
<script src="{{url('/')}}/vicaima/vicaima-cad-door-configuration.js"></script>
<script src="{{url('/')}}/vicaima/vicaima-build-of-material-for-cad-door.js"></script>
<script src="{{asset('vicaima/vicaima-custome-rules.js')}}"></script>
<script src="{{asset('vicaima/vicaima-change-event-calculation.js')}}"></script>
...
<script>
    ...
    function defaultimport(){
        ...
        console.log($("#Leaf1VisionPanel-import").data("value"))
        if($("#Leaf1VisionPanel-import").data("value") == 'Yes'){
            ...
            $("#Leaf1VPWidth").attr('required', false);
  ...
  $('#SL2Depth').val(framDepthValue);
    ...
    //  IntumescentSealArrangementValue2();
     ...
     $('#intumescentSealType').attr({ 'required':false})
       ...
       let doorSetType = $('#doorsetType').val();
        if(doorSetType == 'SD' && (fireRating == 'FD30' || fireRating == 'FD60' || fireRating == 'FD30s' || fireRating == 'FD60s' ||  fireRating == 'NFR')){
          $('.OpHeightMax').html('OP Height (Max-value:2000)');
          $('#oPHeigth').attr('max',2000);
        }

        if(doorSetType == 'DD' && (fireRating == 'FD30' || fireRating == 'FD60' || fireRating == 'FD30s' || fireRating == 'FD60s' ||  fireRating == 'NFR')){

            $('.OpHeightMax').html('OP Height (Max-value:1500)');
            $('#oPHeigth').attr('max',1500);
        }
        let fanLightOverpanel = $('#overpanel').val();
        if((doorSetType == 'DD' || doorSetType == 'SD') && fanLightOverpanel == 'Fan_Light'  && (fireRating == 'FD30' || fireRating == 'FD60' || fireRating == 'FD30s' || fireRating == 'FD60s' ||  fireRating == 'NFR')){
