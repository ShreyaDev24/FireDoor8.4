                ...
                <div class="form-row">
                                ...
                                @foreach ($option_data as $row)
                                    @if ($row->OptionSlug == 'SideLight1')
                                        <option value="{{ $row->OptionKey }}"
                                            @if (isset($Item['SideLight1'])) @if ($Item['SideLight1'] == $row->OptionKey)
                                                                    {{ 'selected' }} @endif
                                        @elseif($row->OptionKey == 'No') {{ 'selected' }} @endif>{{ $row->OptionValue }}</option>
                                    @endif
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="SL1Height" @if (empty($Item['SL1Height'])) {{ 'readonly' }} @endif
                                id="SL1Height" class="form-control SL1 door-configuration" type="text"
                                value="@if (isset($Item['SL1Height'])) {{ $Item['SL1Height'] }} @endif">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <select name="SL1GlassIntegrity"
                                @if (empty($Item['SL1GlassIntegrity'])) {{ 'disabled' }} @endif id="SL1GlassIntegrity"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <select name="sideLight1GlassType"
                                @if (empty($Item['SideLight1GlassType'])) {{ 'disabled' }} @endif id="sideLight1GlassType"
                                class="form-control SL1">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="text" readonly name="sideLight1GlassThickness" id="sideLight1GlassThickness"
                                class="form-control SL1"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="SL1Width" max="600"
                                @if (empty($Item['SL1Width'])) {{ 'readonly' }} @endif id="SL1Width"
                                class="form-control SL1 door-configuration change-event-calulation" type="text"
                                value="@if (isset($Item['SL1Width'])) {{ $Item['SL1Width'] }} @endif">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="text" readonly name="sideLight1GlazingSystems" class="form-control SL1"
                                id="sideLight1GlazingSystems"
                                value="@if (isset($Item['SideLight1GlazingSystems'])) {{ $Item['SideLight1GlazingSystems'] }} @endif">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <select name="SideLight1BeadingType" id="SideLight1BeadingType"
                                @if (empty($Item['BeadingType'])) {{ 'disabled' }} @endif class="form-control SL1">
...
@endforeach -->
                            ...
                            <input type="hidden" name="Beading1TypeOld"
                                value="@if (isset($Item['BeadingType'])) {{ $Item['BeadingType'] }} @endif"
                                id="Beading1TypeOld">
                        </div>
                    </div>
                    {{--  <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group input-icons">
                            ...
                            <i class="fa fa-info icon" id="SideLight1GlazingBeadSpeciesIcon" onClick=""></i>
                            <input type="text" id="SideLight1GlazingBeadSpecies" class="form-control SL1"
                                @if (empty($Item['SL1GlazingBeadSpecies'])) {{ 'disabled' }} @endif value="">
                            <input type="hidden" name="SideLight1GlazingBeadSpecies"
                                id='SideLight1GlazingBeadSpeciesid'
                                value="@if (isset($Item['SL1GlazingBeadSpecies'])) {{ $Item['SL1GlazingBeadSpecies'] }} @endif">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="SlBeadThickness" id="SlBeadThickness"
                                @if (empty(@$Item['SlBeadThickness'])) readonly @else required @endif
                                class="form-control SL1 SlBeadThickness door-configuration" type="text"
                                value="@if (isset($Item['SlBeadThickness'])) {{ $Item['SlBeadThickness'] }} @endif">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input @if (empty(@$Item['SlBeadHeight'])) readonly @else required @endif
                                name="SlBeadHeight" id="SlBeadHeight" class="form-control SL1 door-configuration"
                                type="number"
                                value="@if (isset($Item['SlBeadHeight'])) {{ $Item['SlBeadHeight'] }} @endif">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="SL1Depth" @if (empty($Item['SL1Depth'])) {{ 'readonly' }} @endif
                                id="SL1Depth" class="form-control SL1" type="text"
                                value="@if (isset($Item['SL1Depth'])) {{ $Item['SL1Depth'] }} @endif">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <select name="SL1Transom" @if (empty($Item['SL1Transom'])) {{ 'disabled' }} @endif
                                id="SL1Transom" class="form-control SL1" readonly>
                                <option value="">Select side light 1 transom</option>
                                <option value="No"
                                    @if (isset($Item['SL1Transom'])) @if ($Item['SL1Transom'] == 'No') {{ 'selected' }} @endif
                                    @endif>No</option>
                                @foreach ($option_data as $row)
                                    @if ($row->OptionSlug == 'SideLight1_transom')
                                        <option value="{{ $row->OptionKey }}"
                                            @if (isset($Item['SL1Transom'])) @if ($Item['SL1Transom'] == $row->OptionKey) {{ 'selected' }} @endif
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="SL1TransomDepth" id="SL1TransomDepth" class="form-control SL1"
                                @if (empty($Item['SL1TransomDepth'])) {{ 'readonly' }} @endif type="text"
                                value="@if (isset($Item['SL1TransomDepth'])) {{ $Item['SL1TransomDepth'] }} @endif">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="SL1transomThickness" id="SL1transomThickness" class="form-control SL1"
                                type="text" @if (empty($Item['SL1transomThickness'])) {{ 'readonly' }} @endif
                                value="@if (isset($Item['SL1transomThickness'])) {{ $Item['SL1transomThickness'] }} @endif">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <select name="sideLight2" id="sideLight2"
                                class="form-control door-configuration change-event-calulation" required>
                                <option value=""> Is side light 2 is active?</option>
                                @foreach ($option_data as $row)
                                    @if ($row->OptionSlug == 'SideLight2')
                                        <option value="{{ $row->OptionKey }}"
                                            @if (isset($Item['SideLight2'])) @if ($Item['SideLight2'] == $row->OptionKey)
                                                                    {{ 'selected' }} @endif
                                        @elseif($row->OptionKey == 'No') {{ 'selected' }} @endif>{{ $row->OptionValue }}</option>
                                    @endif
                                @endforeach
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <select name="copyOfSideLite1" id="copyOfSideLite1"
                                class="form-control door-configuration change-event-calulation"
                                ...
                                @foreach ($option_data as $row)
                                    @if ($row->OptionSlug == 'copy_Same_as_SL1')
                                        <option value="{{ $row->OptionKey }}"
                                            @if (isset($Item['DoYouWantToCopySameAsSL1'])) @if ($Item['DoYouWantToCopySameAsSL1'] == $row->OptionKey) {{ 'selected' }} @endif
                                            @endif>{{ $row->OptionValue }}</option>
                                    @endif
                                @endforeach
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="SL2Height"
                                @if (isset($Item['SideLight2']) && $Item['SideLight2'] == 'Yes') @if (isset($Item['DoYouWantToCopySameAsSL1']) && $Item['DoYouWantToCopySameAsSL1'] == 'Yes')
                                                                {{ 'readonly' }} @endif
                            @else {{ 'readonly' }} @endif
                            id="SL2Height" class="form-control door-configuration"
                            type="text"
                            value="@if (isset($Item['SL2Height'])) {{ $Item['SL2Height'] }} @endif">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <select name="SL2GlassIntegrity"
                                @if (empty($Item['SL2GlassIntegrity'])) {{ 'disabled' }} @endif id="SL2GlassIntegrity"
                                class="form-control">
                                <option value=''> Select Side Light 1 Glass Integrity</option>
                            </select>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="text" readonly name="sideLight2GlassThickness"
                                id="sideLight2GlassThickness" class="form-control sidelight2section"
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            type="text"
                            value="@if (isset($Item['SL2Width'])) {{ $Item['SL2Width'] }} @endif">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input type="text" id="sideLight2GlazingSystems" name="sideLight2GlazingSystems"
                                readonly class="form-control sidelight2section"
                                value="@if (isset($Item['SideLight2GlazingSystems'])) {{ $Item['SideLight2GlazingSystems'] }} @endif">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group input-icons">
                            ...
                            <i class="fa fa-info icon" id="SideLight2GlazingBeadSpeciesIcon" onClick=""></i>
                            <input type="text" id="SideLight2GlazingBeadSpecies" class="form-control"
                                @if (isset($Item['SideLight2']) && $Item['SideLight2'] == 'Yes') @if (isset($Item['DoYouWantToCopySameAsSL1']) && $Item['DoYouWantToCopySameAsSL1'] == 'Yes')
                                                                {{ 'disabled' }} @endif
                            @else {{ 'disabled' }} @endif
                            value="">
                            <input type="hidden" name="SideLight2GlazingBeadSpecies"
                                id='SideLight2GlazingBeadSpeciesid'
                                value="@if (isset($Item['SideLight2GlazingBeadSpecies'])) {{ $Item['SideLight2GlazingBeadSpecies'] }} @endif">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            type="text"
                            value="@if (isset($Item['SL2Depth'])) {{ $Item['SL2Depth'] }} @endif">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            @else {{ 'disabled' }} @endif
                                ...
                                <option value="No"
                                    @if (isset($Item['SL2Transom'])) @if ($Item['SL2Transom'] == 'No') {{ 'selected' }} @endif
                                    @endif>No</option>
                                @foreach ($option_data as $row)
                                    @if ($row->OptionSlug == 'SideLight2_transom')
                                        <option value="{{ $row->OptionKey }}"
                                            @if (isset($Item['SL2Transom'])) @if ($Item['SL2Transom'] == $row->OptionKey) {{ 'selected' }} @endif
                                            @endif>{{ $row->OptionValue }}</option>
                                    @endif
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="SL2TransomDepth" id="SL2TransomDepth" class="form-control"
                                @if (empty($Item['SL2TransomDepth'])) {{ 'readonly' }} @endif type="text"
                                value="@if (isset($Item['SL2TransomDepth'])) {{ $Item['SL2TransomDepth'] }} @endif">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="SL2transomThickness" id="SL2transomThickness" class="form-control"
                                type="text" @if (empty($Item['SL2transomThickness'])) {{ 'readonly' }} @endif
                                value="@if (isset($Item['SL2transomThickness'])) {{ $Item['SL2transomThickness'] }} @endif">
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group input-icons">
                            ...
                            <label for="SLtransom_Height_From_Top" style="display: none;">Transom height from
                                top</label>
                            <input type="text" id="SLtransomHeightFromTop" name="SLtransomHeightFromTop"
                                class="form-control"
                                value="@if (isset($Item['SLtransomHeightFromTop'])) {{ $Item['SLtransomHeightFromTop'] }} @endif">
...
<input type="hidden" name="sidelight1GlassWidth"
    value="@if (isset($Item['SideLight1GlassWidth'])) {{ $Item['SideLight1GlassWidth'] }} @endif"
    id="sidelight1GlassWidth">
<input type="hidden" name="sidelight2GlassWidth"
    value="@if (isset($Item['SideLight2GlassWidth'])) {{ $Item['SideLight2GlassWidth'] }} @endif"
    id="sidelight2GlassWidth">
<input type="hidden" name="sidelight1GlassHeight"
    value="@if (isset($Item['Sidelight1GlassHeight'])) {{ $Item['Sidelight1GlassHeight'] }} @endif"
    id="sidelight1GlassHeight">
