                        ...
                        <div class="main-card mb-3 custom_card">
                            <div>
                                <div class="tab-content">
                                    <div style="display: none; color: red; font-weight: bold;" id="checking-level">
                                        <span>Frame Material is not available for these fire rating, please choose another.</span>
                                    </div>
                                    ...
                                    <div>
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    <label for="rebatedWidth" id="ScallopedLabelWidth">Scalloped Width (min32)
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    <label for="rebatedHeight" id="ScallopedLabelDepth">Scalloped Depth (min 12)
