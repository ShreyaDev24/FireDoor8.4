                    ...
                    <form id="itemForm" enctype="multipart/form-data">
                        ...
                        <div class="tab-content">
                            <div id="main-options-section" class="tab-pane active">
                                @include("Items.Flamebreak.FlamebreakDoorModules.MainOptions")
                            </div>

                            <div id="door-dimensions-n-door-leaf-section" class="tab-pane fade">
                                @include("Items.Flamebreak.FlamebreakDoorModules.DoorDimensionsAndDoorLeaf")
                            </div>

                            <div id="vision-panel-section" class="tab-pane fade">
                                @include("Items.Flamebreak.FlamebreakDoorModules.VisionPanel")
                            </div>

                            <div id="frame-section" class="tab-pane fade framehideshow">
                                @include("Items.Flamebreak.FlamebreakDoorModules.Frame")
                            </div>

                            <div id="over-panel-section" class="tab-pane fade framehideshow">
                                @include("Items.Flamebreak.FlamebreakDoorModules.OverPanel")
                            </div>

                            <div id="side-light-section" class="tab-pane fade framehideshow">
                                @include("Items.Flamebreak.FlamebreakDoorModules.SideLight")
                            </div>

                            <div id="lipping-and-intumescent-section" class="tab-pane fade">
                                @include("Items.Flamebreak.FlamebreakDoorModules.LippingAndIntumescent")
                            </div>

                            <div id="acoustics-section" class="tab-pane fade">
                                @include("Items.Flamebreak.FlamebreakDoorModules.Accoustics")

                            </div>

                            <div id="architrave-section" class="tab-pane fade framehideshow">
                                @include("Items.Flamebreak.FlamebreakDoorModules.Architrave")
                            </div>

                            <div id="transport-section" class="tab-pane fade">
                                <!-- @include("Items.Flamebreak.FlamebreakDoorModules.Transport") -->
                            </div>
                        </div>
...
<script src="{{url('/')}}/Flamebreak/flamebreak-build-of-material-for-cad-door.js"></script>
<script src="{{asset('Flamebreak/flamebreak-cad-door-configuration.js')}}"></script>
<script src="{{asset('Flamebreak/flamebreak-custome-rules.js')}}"></script>
<script src="{{asset('Flamebreak/flamebreak-change-event-calculation.js')}}"></script>
...
<script>
    ...
    function defaultimport(){
        $("select[name=intumescentLeafType]").val(10).trigger("change");
        ...
        if($("#Leaf2VisionPanel-import").data("value") == "Yes"){
            ...
            if($("#Leaf2VisionPanelQuantity-import").data("value") == 1){
        ...
        $(".form-control").each(function(index) {
            ...
            setTimeout(function() {
                ...
                edgeValue($("#DistanceFromTheEdgeOfDoor-import").data("value"))
