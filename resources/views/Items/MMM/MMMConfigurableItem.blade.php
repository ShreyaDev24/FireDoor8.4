        ...
        <div class="form-row">
           ...
           <div class="item-form">
                <form id="itemForm" enctype="multipart/form-data" >
                    <input type="hidden" name="pageIdentity" id="pageIdentity" value="9">
...
<script src="{{url('/')}}/MMM/MMM-cad-door-configuration.js"></script>
<script src="{{url('/')}}/MMM/MMM-build-of-material-for-cad-door.js"></script>
<script src="{{asset('MMM/MMM-custome-rules.js')}}"></script>
<script src="{{asset('MMM/MMM-change-event-calculation.js')}}"></script>
