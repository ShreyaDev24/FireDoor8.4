...
<head>
    ...
    <style>
        ...
        .frame_dd_t1_Scalloped{
            margin-top: 4px !important;
        }
        .frame_dd_t1_Scalloped::before{
            width: 88px !important;
        }

        .frame_dd_t2_Scalloped{
            margin-top: -16px !important;
        }
        .frame_dd_t2_Scalloped::after{
            right: 64px !important;
            width: 39px !important;
        }
        .frame_dd_t2_Rebated_Frame::after{
            right: 68px !important;
            width: 38px !important;
            top: -1px !important;
        }
        .frame_dd_t3_Scalloped{
            display: none !important;
        }
        .frame_dd_t3_Scalloped::after{
          display: none !important;
        }
        .frame_dd_t4_Scalloped{
            margin-top: 90px;
            width: 91px !important;
        }
        .frame_dd_t4_Scalloped::after{
            width: 8px !important;
        }
        .frame_dd_t5_Scalloped{
            margin-top: 0px !important;
        }
        .frame_dd_t5_Scalloped::after{
            width: 30px !important;
        }


        .frame_dd_t1_sd_Scalloped{
            /* margin-left: 63px !important; */
            margin-top: 14px !important;
        }
        td.mytabledata_sd > .frame_dd_t1_sd_Scalloped::before {
        width: 168px !important;
        }
        .frame_dd_t2_sd_Rebated_Frame{
            margin-top: -43px !important;
        }
        td.mytabledata_sd > .frame_dd_t2_sd_Rebated_Frame::after {
            width: 62px !important;
            right: 49px !important;
            top: -1px !important;
        }
        .frame_dd_t2_sd_Scalloped{
            margin-top: -43px !important;
        }
        td.mytabledata_sd > .frame_dd_t2_sd_Scalloped::after {
            width: 74px !important;
            right: 46px !important;
        }
        .frame_dd_t3_sd_Scalloped{
           display:none !important;
        }
        td.mytabledata_sd > .frame_dd_t4_sd_Scalloped::after {
            width: 10px !important;
            right: 73px !important;
        }
        .frame_dd_t4_sd_Scalloped{
            margin-top: 150px !important;
        }
        /* .frame_dd_t5_sd_Scalloped{
           display:none !important;
        } */
...
.fir-dr-tbl table,.fir-dr-tbl th,.fir-dr-tbl td {
...
.fir-dr-tbl, .mytableclass td,th{
    border: 1px solid !important;
}

.fir-dr-tbl, .mytableclass{
    width: 800px;
...
<body>
    ...
    {!! htmlspecialchars_decode($elevTbl) !!}
</body>
