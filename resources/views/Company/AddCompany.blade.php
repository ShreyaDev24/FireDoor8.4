        ...
        <div class="custom_card">
            <div class="tab-card-body">
                <ul class="nav nav-pills mb-3 tablist" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item tab-item">
                        <a class="nav-link show disable_tab" id="pills-office-tab" data-toggle="pill" href="#office" role="tab" aria-controls="office" aria-selected="false">Address</a>
                    </li>
                    <li class="nav-item tab-item">
                ...
                <form id="signupForm" enctype="multipart/form-data" method="post" action="{{route('company/store')}}">
                                ...
                                <div class="pt-0">
                                    <div class="tab-content">
                                        <div class="">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group"><label for="Company Name" class="">Company Name<span class="text-danger">*</span></label>
                                                        <input name="CompanyName" required placeholder="Enter Company Name" value="@if(isset($editdata->id)){{$editdata->CompanyName}}@else{{old('CompanyName')}}@endif" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        <label for="Website url" class="">Website</label>
                                                        <input name="CompanyWebsite" value="@if(isset($editdata->id)){{$editdata->CompanyWebsite}}@else{{old('CompanyWebsite')}}@endif" placeholder="Enter Company Website" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group"><label for="Company Phone" class="">Company Phone<span class="text-danger">*</span></label>
                                                        <input name="CompanyPhone" value="@if(isset($editdata->id)){{$editdata->CompanyPhone}}@else{{old('CompanyPhone')}}@endif" required placeholder="Enter Company Phone Number" type="number" class="form-control" onkeydown="if(event.key==='.'){event.preventDefault();}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        <label for="Company VAT" class="">Company VAT Number</label>
                                                        <input name="CompanyVatNumber" value="@if(isset($editdata->id)){{$editdata->CompanyVatNumber}}@else{{old('CompanyVatNumber')}}@endif" placeholder="Enter Company Company VAT Number" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="position-relative form-group">
                                                ...
                                                <div class="col-md-2">
                                                    @if(isset($editdata->id))
                                                    <img src="{{url('/')}}/CompanyLogo/{{$editdata->UserImage}}" class="" width="100px">
                                                    <input type="hidden" id="imageurl" value="{{$editdata->UserImage}}">
                                                    @endif
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="CompanyAddressLine1" id="searchTextField" value="@if(isset($editdata->id)){{$editdata->CompanyAddressLine1}}@else{{old('CompanyAddressLine1')}}@endif" required placeholder="Address Line 1" type="text" class="form-control">
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="CompanyCountry" id="Country" value="@if(isset($editdata->id)){{$editdata->CompanyCountry}}@else{{old('CompanyCountry')}}@endif" required placeholder="Enter Country" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        <label for="State" class="">State<span class="text-danger">*</span></label>
                                                        <input name="CompanyState" id="State" value="@if(isset($editdata->id)){{$editdata->CompanyState}}@else{{old('CompanyState')}}@endif" required placeholder="Enter State" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        <label for="City" class="">City<span class="text-danger">*</span></label>
                                                        <input name="CompanyCity" id="City" value="@if(isset($editdata->id)){{$editdata->CompanyCity}}@else{{old('CompanyCity')}}@endif" required placeholder="Enter City" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        <label for="PostalCode" class="">Postal Code/Eircode<span class="text-danger">*</span></label>
                                                        <input name="CompanyPostalCode" id="PinCode" value="@if(isset($editdata->id)){{$editdata->CompanyPostalCode}}@else{{old('CompanyPostalCode')}}@endif" required placeholder="Enter Postal Code/Eircode" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                        ...
                        <div class="tab-pane fade" id="admin" role="tabpanel" aria-labelledby="admin">
                            <div class="main-card mb-3">
                                    ...
                                    <h5 class="card-title" style="margin-top: 10px">Add Admin Details</h5>
                                        ...
                                        <div class="pt-0">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        <label for="UserPhone" class="">Password<span class="text-danger">*</span></label>
                                                        <input name="newpassword" id="newpassword" placeholder="Enter New Password" type="password" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="position-relative form-group">
                                                        <input type="checkbox" id="sendMail" name="sendMail" value="1">
                                                        <label for="Company Moreinfo" class="form-check-label">Send login details to company admin</label>
                                                    </div>
                                                </div>
                                                @endif
                                            </div>
                                ...
                                <div class="d-block text-right card-footer">
                                    ...
                                    <button type="button" id="submit_btn" onclick="submit_form()" class="btn-wide btn btn-success" style="margin-right: 20px">
                                        @if(isset($editdata->id))
                                        Update Now
                                        @else
                                        Submit Now
...
<script type="text/javascript">
    ...
    function submit_form() {
        ...
        var UserJobtitle = $("input[name=UserJobtitle]").val();
        if ($('#UserId').val()) {
            CompanyLogo = $('#imageurl').val();
        }
        if (CompanyName == '' || CompanyPhone == '' || CompanyEmail == '' || CompanyLogo == '') {
