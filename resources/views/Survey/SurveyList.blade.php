                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card-header">
                                <h5 class="card-title">Survey Users</h5>
                            </div>
                        </div>
                        <div class="col-sm-6 ">

                            @if (Auth::user()->UserType == '2')
                                <a href="{{ route('survey/add') }}" class="btn-shadow btn btn-info float-right">
                                    Add New
                                </a>
                            @endif
                        </div>
