...
@section('main_section')
    ...
    <div class="app-main__outer">
        ...
        @endif
            ...
            <form id="signupForm" enctype="multipart/form-data" method="post" action="{{ route('survey/store') }}"
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="card-header">
                                    <h5 class="card-title" style="margin-top: 10px">Add Survey User</h5>
                                </div>
                                <div class="card-body">
                                    <div class="form-row">
                                        <div class="col-md-6">
                                        ...
                                        @if (isset($editdata->id) && isset($editdata->UserImage))
                                            <div class="col-lg-2 col-md-12 d-flex justify-content-center">
                                                <img src="{{ url('/') }}/UserImage/{{ $editdata->UserImage }}" alt="No Image" width="100px" height="100px" style=" margin: 28px 0px 10px 0px;border-radius: 10px;">
