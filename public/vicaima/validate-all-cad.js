...
window.render = (CustomElement = null,formValues = {}) => {
    ...
    if(formValues.FourSidedFrame == 1){
        var IsFourSidedFrame = 1;
    } else {
        var IsFourSidedFrame = 0;
    }
    ...
    if (frameonoff == 1) {
        ...
        SOHeight= formValues.LeafHeight;
    }
    if(SOHeight == ""){
        SOHeight = 0;
    }else{
    ...
    ScallopedHeight = formValues.ScallopedHeight;
    if(ScallopedHeight == ""){
        ScallopedHeight = 0;
    }
     ...
     if (frameonoff || (DoorSetType == "DD") ) {
        var framewidthToShow = SOWidth  //width changed
            ...
            const  SOWidths= formValues.LeafWidth1;
            var framewidthToShow = SOWidths ;
             }
             var frameType = formValues.frameType;
    var FrameWidth = parseInt(formValues.FrameWidth, 10);
    ...
    if(DoorSetType == "DD" && withoutFrameId != 1){
        let leafWidth1Value =  formValues.LeafWidth1
        ...
        LeafWidth2 =  parseInt(formValues.LeafWidth2, 10);
        //  console.log(LeafWidth1);
    }
     //  console.log(LeafWidth1);

     if (withoutFrameId == 1) {
         var LeafHeightNoOP = formValues.LeafWidth1;
         var SOHeight = formValues.LeafHeight;
         var SOWidth = parseInt(formValues.LeafWidth1, 10);
         var LeafWidth1 = parseInt(formValues.LeafWidth2, 10);
         if (DoorSetType == "DD") {
     ...
     var LeafHeightNoOP = formValues.LeafHeight; //height changed
    //  var LeafHeightNoOP = SOHeight - Tollerance - FrameThickness - UnderCut - Gap;
     let foursidedframe = formValues.FourSidedFrame;
     if (foursidedframe == 1) {
     ...
     if (SideLightPanel1 == "Yes") {
         ...
         if (ShowMeasurements) {
             // //  console.log('================================', SideLightPanel1Width)
             if (SideLightPanel1Width > 0) {
  ...
  var IronmongerySet = formValues.IronmongerySet;
  var IronmongeryID = formValues.IronmongeryID;
...
//end 07-01-2024
  ...
  if (Leaf1VisionPanel == "Yes") {
      ...
      if (Handing == 'Right') {
          ...
          var DistanceXForLeaf1VPShape = ix + LeftGapForLeaf1 + LeftSideDistanceOfVisonPanelOfDoorLeaf1;
          var DistanceYForLeaf1VPShape = iy + GapAfterOverPanelApplied + UpperAndLowerGap + parseFloat(DistanceFromTopOfDoorForLeaf1);
          console.log(ix ,LeftGapForLeaf1 , LeftSideDistanceOfVisonPanelOfDoorLeaf1)
      ...
      if (Leaf1VisionPanel1Height && Leaf1VisionPanelWidth) {
        //  console.log(Leaf1VisionPanelWidth,LeafWidth1ForMap,VisionPanelShape,DistanceXForLeaf1VPShape,Leaf1VisionPanelWidth,Leaf1VisionPanel1Height,Leaf1VisionPanelWidthToShow)
        ...
        if (VisionPanelQuantityForLeaf1 > 1) {
            ...
            if (VisionPanelShape == "Diamond") {
                ...
                svg.append("circle")
                    ...
                    .attr("cx", DistanceXForLeaf1VPShape + CircleRadius)
                    .attr("cy", DistanceYForLeaf1VPShape + CircleRadius);
                    console.log(DistanceXForLeaf1VPShape,CircleRadius)
            } else {
                svg.append('rect')
                    .attr('x', DistanceXForLeaf1VPShape)
                    .attr('y', DistanceYForLeaf1VPShape)
  ...
  if (DoorSetType == "DD") {
      ...
      if (Leaf2VisionPanel == "Yes") {
          ...
          //  console.log(DistanceXForLeaf2VPShape)
