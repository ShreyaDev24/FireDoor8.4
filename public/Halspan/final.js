        ...
        if (IronmongerySet == "Yes" && IronmongeryID != "") {
            ...
            ParsedIronmongerySet.forEach(function (elem, index) {
                if (elem.id == IronmongeryID) {
                    ...
                    if (elem.kickPlatesQty != '' && elem.kickPlatesQty != null && Array.isArray(elem.additional_info)) {
                        IsKickPlateEnable = true;
                        const KickPlatesData = elem.additional_info.find((item) => item.Category === "KickPlates");
                        KickPlatesHeight = KickPlatesData?.staticHeight ?? 0;
                    }

                    if (elem.doorSignageQty != '' && elem.doorSignageQty != null && Array.isArray(elem.additional_info)) {
                    ...
                    if (elem.FaceFixedDoorCloser != '' && elem.FaceFixedDoorCloser != null && Array.isArray(elem.additional_info)) {
                    ...
                    if (elem.pullHandlesQty != '' && elem.pullHandlesQty != null && Array.isArray(elem.additional_info)) {
                    ...
                    if (elem.Morticeddropdownseals != '' && elem.Morticeddropdownseals != null && Array.isArray(elem.additional_info)) {
                        IsMorticedDropdownSealsEnable = true;

                    }
                    if (elem.Facefixeddropseals != '' && elem.Facefixeddropseals != null && Array.isArray(elem.additional_info)) {
...
// console.log(d3.select('svg').node())
    ...
    var encodedData = "data:image/svg+xml;base64," + window.btoa(unescape(encodeURIComponent(source)));

    // Optional: remove the SVG now
...
$(document).ready(function () {
    ...
    render($('.change-dimension'));  // Instead of looping through each form control, call render with all of them
    // render(element);
});

// $(".form-control").each(function() {
//         var element = $(this);
//         render(element);  // Call render function with each element
//     });
