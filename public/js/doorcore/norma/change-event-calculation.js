    ...
    if(overPanel=="Fan_Light"){
     ...
     // calculating undercut
       if(floorFinish!=''){
        ...
        //        }
        //     });
        //     alert(UnderCutAdditionalNumber)
        ...
        var so_width = parseInt($("#leafWidth2").val());

         $("#frameWidth").val(so_width-(parseInt(tollerance)*TolleranceAdditionalNumberForFrameWidth));
