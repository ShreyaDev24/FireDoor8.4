...
Route::post('/quotationSignature/submit',
    [App\Http\Controllers\PrintInvoiceController::class, 'submitSignature']
)->withoutMiddleware(['auth'])
 ->name('signaturesubmit');
Route::get('printinvoiceclient/{v}/{qid}/{isActive?}', [App\Http\Controllers\PrintInvoiceController::class,'printinvoiceclient'])->name('printinvoiceclient');
...
Route::prefix('quotation')->group(function (): void {
    ...
    Route::post('/DoorNoChangeUrl', [App\Http\Controllers\DoorScheduleController::class,'DoorNoChangeUrl'])->name('quotation/DoorNoChangeUrl');
    ...
    Route::get('/ExportHangingDocument/{id}/{vid}', [App\Http\Controllers\DoorScheduleController::class,'ExportHangingDocument'])->name('ExportHangingDocument');
    Route::get('/PickListExport/{id}/{vid}', [App\Http\Controllers\DoorScheduleController::class,'PickList'])->name('PickListExport');
