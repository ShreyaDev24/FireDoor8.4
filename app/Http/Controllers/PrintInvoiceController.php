...
// dd(\Config::get('constants.base64Images.ScallopedLeft'),"139");
        ...
        $pdf2 = PDF::loadView('Company.pdf_files.quotationsummarypdf', ['comapnyDetail' => $comapnyDetail, 'project' => $project, 'quotaion' => $quotaion, 'pdf2' => $pdf2, 'pdf_footer' => $pdf_footer, 'totDoorsetType' => $totDoorsetType, 'totIronmongerySet' => $totIronmongerySet, 'totDoorsetPrice' => number_format((float)$totDoorsetPrice,2), 'totIronmongaryPrice' => number_format((float)$totIronmongaryPrice,2), 'nonConfigDataPrice' => number_format((float)$nonConfigDataPrice,2), 'nettot' => number_format((float)$nettot,2), 'QSTI' => $QSTI, 'customerContact' => $customerContact, 'customer' => $customer, 'user' => $user, 'nonConfigDataCount' => $nonConfigDataCount, 'contractorName' => $contractorName, 'ScreenSetQty' => $ScreenSetQty, 'screenDataprice' => number_format((float)$screenDataprice,2), 'currency' => $currency, 'transportationCost' => $transportationCost]);
