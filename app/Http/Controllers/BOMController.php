       ...
       $data = [];
        foreach ($item as $value) {
            ...
            if ($value->GlassType != '' && $value->GlassThickness != '' &&
                ...
                $height = (!is_null($glassHeight) && $glassHeight !== '' && (float)$glassHeight > 0) ? ($glassHeight - $value->Leaf1VPHeight1) : $value->Leaf1VPHeight1;

                $width = (!is_null($glassWidth) && $glassWidth !== '' && (float)$glassWidth > 0) ? ($glassWidth - $value->Leaf1VPWidth) : $value->Leaf1VPWidth;
