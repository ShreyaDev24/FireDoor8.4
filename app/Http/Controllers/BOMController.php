        ...
        <table style="width: 1500px; border-collapse: collapse; font-size: 10px; margin-top: 10px; border: 1px solid black;">
            <thead>
                <tr style="background: #ddd; border: 1px solid black;">
                    ...
                    <th style="border: 1px solid black; padding: 5px;">Notes,Please any non-conformance of quantity issues</th>';
                    ...
                    <table style="width: 1500px; border-collapse: collapse; font-size: 10px; margin-top: 10px; border: 1px solid black;">
                        <thead>
                            <tr style="background: #ddd; border: 1px solid black;">
                                ...
                                <th style="border: 1px solid black; padding: 5px;">Lipping Thickness/Lipping Species</th>
