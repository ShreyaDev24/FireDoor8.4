...
class pdf4 implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $version = $qv->version;
         ...
         if($quotaion->configurableitems == 4){
             $pdf4 = PDF::loadView('Company.pdf_files.vicaima.pdf2', compact('a', 'comapnyDetail', 'project', 'customerContact', 'version', 'customer'));
         }else{
             $pdf4 = PDF::loadView('Company.pdf_files.pdf2', compact('a', 'comapnyDetail', 'project', 'customerContact', 'version', 'customer'));
         }
