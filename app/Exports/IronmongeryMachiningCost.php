...
class IronmongeryMachiningCost implements FromCollection,WithHeadings,WithEvents,WithTitle,WithColumnFormatting
{
    ...
    {
        return 'Ironmongery Machining Cost';
    }
