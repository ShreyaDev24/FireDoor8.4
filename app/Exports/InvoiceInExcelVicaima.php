...
class InvoiceInExcelVicaima implements FromCollection,WithHeadings,WithEvents
{
    /**
    ...
    */
    ...
    public function collection()
    {
        ...
        foreach($shows as $item){
            ...
            // $ArchitraveMaterial = '';
            // if($item->ArchitraveMaterial){
            //     $SelectedArchitraveMaterial = LippingSpecies::find($item->ArchitraveMaterial);
            //     if($SelectedArchitraveMaterial != null){
            //         $ArchitraveMaterial = $SelectedArchitraveMaterial->SpeciesName;
            //     }
            // }
            ...
            $doorDimension = $item->DoorDimensionsCode;
            $doorLeafType = $item->LeafConstruction;
            $Floor = $item->floor;
