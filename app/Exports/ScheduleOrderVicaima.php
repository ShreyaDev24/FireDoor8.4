...
class ScheduleOrderVicaima implements FromCollection,WithHeadings,WithEvents
{
    ...
    public function collection()
    {
        ...
        $item = Items::join('item_master','items.itemId','item_master.itemID')
                ...
                ->whereIn('items.configurableitems', [4,5,6,9])
                ->get();
    ...
    public function headings(): array
    {
        $a = [
            ...
            'Number Of Groove ',
            'Decorative Grooves Leaf2',
            'Is Same As Decorative Grooves 1',
            'Groove Icon Leaf2',
            'Groove Width Leaf2',
            'Groove Depth Leaf2',
            ...
            'CoreWidth2 ',
            'CoreHeight ',
            'Intumescent Lipping Seal Type ',
            'Intumescent Lipping Seal Location ',
            'Intumescent Lipping Seal Color ',
            'Intumescent Lipping Seal Arrangement ',
